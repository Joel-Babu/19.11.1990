...
public class DailyPlanningGroup extends TestBase {

	protected Logger log = LogManager.getLogger(DailyPlanningGroup.class);
	TestStatus status;
	...
	@Test(description = "Daily Planning - Group, Sales View", priority = 1)
	public void SalesView() throws Exception {
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.DPscreenToView, "Group");
		/*pageWeeklyPlanningPO.verifyPageName(extentTest, objWeeklyPlanningStoreObjects.DataFrame,
				objWeeklyPlanningStoreObjects.pageName, getContext().getStringProperty("DailyPlanningGroup"));*/
	...
	@Test(description = "Daily Planning - Group, Hours View", priority = 2)
	public void ScheduledHoursView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 1) {
				...
				extentTest = report.startTest("PayHours - Day Wise Data Validation");

				pageDailyTradingStatementStorePO.CompareValueDecimalORFields(extentTest, PayHoursDBValues,
						PayHoursUIValues);

				Report_AddStep("testcase", " HOURS VIEW - DAY WISE TOTAL", "", "", "");
				extentTest = report.startTest("PayHours - Day Wise Total Validation");

				pageDailyTradingStatementStorePO.CompareValueDecimalORTotal(extentTest, PayHoursDBTotal,
						PayHoursUITotal);

				Report_AddStep("testcase", " HOURS VIEW - WEEK TO DATE ", "", "", "");
				extentTest = report.startTest("PayHours - Week to Date data Validation");

				pageWeeklyPlanningPO.CompareValueDecimalORFields(extentTest, PayHoursDBWkToDate, PayHoursUIWkToDate);

				Report_AddStep("testcase", " HOURS VIEW - WEEK TO DATE TOTAL", "", "", "");
				extentTest = report.startTest("PayHours - Week to Date Total Validation");
	...
	@Test(description = "Daily Planning - Group, Wages View", priority = 3)
	...
	@Test(description = "Daily Planning - Group, WagesPercentage View", priority = 4)
	...
	@Test(description = "Daily Planning - Group, Operatinoal Ratio View", priority = 5)
	public void ORPercentageView() throws Exception {
		...
		/*	if (i == 1) {
				...
				Report_AddStep("testcase", " OPERATIONAL RATIO VIEW - DAY WISE ", "", "", "");
				extentTest = report.startTest("Pay Plan - Day Wise Data Validation");

				pageDailyTradingStatementStorePO.CompareValueDecimalORFields(extentTest, PayPlanDBValues,PayPlanUIValues);

				Report_AddStep("testcase", " OPERATIONAL RATIO VIEW - DAY WISE TOTAL", "", "", "");
				extentTest = report.startTest("Pay Plan - Day Wise Total Validation");

				pageDailyTradingStatementStorePO.CompareValueDecimalORTotal(extentTest, PayPlanDBTotal, PayPlanUITotal);

				Report_AddStep("testcase", " OPERATIONAL RATIO VIEW - WEEK TO DATE ", "", "", "");
				extentTest = report.startTest("Pay Plan - Week to Date data Validation");

				pageWeeklyPlanningPO.CompareValueDecimalORFields(extentTest, PayPlanDBWkToDate, PayPlanUIWkToDate);
	...
	@Test(description = "Daily Planning - Group, Items View", priority = 6)
	...
	@Test(description = "Daily Planning - Group, Items Price View", priority = 7)
	...
	@Test(description = "Daily Planning - Group, Customers View", priority = 8)
	...
	@Test(description = "Daily Planning - Group, CPH View", priority = 9)
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\DailyPlanningGroup_ALL.xml");
