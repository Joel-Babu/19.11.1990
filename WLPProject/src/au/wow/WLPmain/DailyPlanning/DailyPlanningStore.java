...
public class DailyPlanningStore extends TestBase {

	protected Logger log = LogManager.getLogger(DailyPlanningStore.class);
	TestStatus status;
	...
	String OptionToView = null, Month, Input;

	public DailyPlanningStore() {
		super.log = log;
	}
	...
	@Test(description = "Daily Planning - Store, Sales View", priority = 1)
	public void SalesView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			if (i == 0) {
				...
				UIValues = pageDailyPlanningPO.UIResultsStore(objDailyPlanningStoreObjects,
				...
				UIWkToDate = pageDailyPlanningPO.WkToDtValueStore(objDailyPlanningStoreObjects,
						objDailyPlanningStoreObjects.PlannedTable, objDailyPlanningStoreObjects.Departments,
			...
			Report_AddStep("testcase", "Day Wise Data Validation", "", "", "");
			extentTest = report.startTest("Day Wise Data Validation");

			pageDailyTradingStatementStorePO.DTSCompareValues(extentTest, DBValues, UIValues);

			Report_AddStep("testcase", "Day Wise Total Validation", "", "", "");
			...
			Report_AddStep("testcase", "Week to Date data Validation", "", "", "");
			...
			Report_AddStep("testcase", "Week to Date Total Validation", "", "", "");
	...
	@Test(description = "Daily Planning - Store, Hours View", priority = 2)
	public void ScheduledHoursView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			if (i == 0) {
				...
				extentTest = report.startTest("Planned Hours Validation");
				...
				PayHoursUIValues = pageDailyPlanningPO.UIResultsStore(objDailyPlanningStoreObjects,
						objDailyPlanningStoreObjects.ActualHRTable, objDailyPlanningStoreObjects.ActualHrDepartments,
				...
				PayHoursUIWkToDate = pageDailyPlanningPO.WkToDtValueStore(objDailyPlanningStoreObjects,
						objDailyPlanningStoreObjects.ActualHRTable, objDailyPlanningStoreObjects.ActualHrDepartments,
				...
				pageWeeklyPlanningPO.CompareValueDecimalORFields(extentTest, DBWkToDate, UIWkToDate);
				...
				extentTest = report.startTest("Pay Hours - Day Wise Data Validation");

				pageDailyTradingStatementStorePO.CompareValueDecimalORFields(extentTest, PayHoursDBValues,
						PayHoursUIValues);

				Report_AddStep("testcase", " HOURS VIEW - DAY WISE TOTAL", "", "", "");
				extentTest = report.startTest("Pay Hours - Day Wise Total Validation");

				pageDailyTradingStatementStorePO.CompareValueDecimalORTotal(extentTest, PayHoursDBTotal,
						PayHoursUITotal);

				Report_AddStep("testcase", " HOURS VIEW - WEEK TO DATE ", "", "", "");
				extentTest = report.startTest("Pay Hours - Week to Date data Validation");

				pageMonthlyPlanningPO.CompareValuesforOR(extentTest, PayHoursDBWkToDate, PayHoursUIWkToDate);

				Report_AddStep("testcase", " HOURS VIEW - WEEK TO DATE TOTAL", "", "", "");
				extentTest = report.startTest("Pay Hours - Week to Date Total Validation");
	...
	@Test(description = "Daily Planning - Store, Wages View", priority = 3)
	...
	@Test(description = "Daily Planning - Store, WagesPercentage View", priority = 4)
	public void WagesPercentageView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			pageDailyTradingStatementStorePO.CompareValueDecimalFields(extentTest, DBValues, UIValues);
	...
	@Test(description = "Daily Planning - Store, Operatinoal Ratio View", priority = 5)
	public void ORPercentageView() throws Exception {
		...
		/*	if (i == 1) {
				...
				PayPlanUIValues = pageDailyPlanningPO.UIResultsStore(objDailyPlanningStoreObjects,
						objDailyPlanningStoreObjects.ActualORTable, objDailyPlanningStoreObjects.ORDepartmentsActl,
				...
				PayPlanUIWkToDate = pageDailyPlanningPO.WkToDtValueStore(objDailyPlanningStoreObjects,
						objDailyPlanningStoreObjects.ActualORTable, objDailyPlanningStoreObjects.ORDepartmentsActl,
				...
				pageDailyTradingStatementStorePO.CompareValueDecimalORFields(extentTest, PayPlanDBValues,
						PayPlanUIValues);
	...
	@Test(description = "Daily Planning - Store, Items View", priority = 6)
	...
	@Test(description = "Daily Planning - Store, Items Price View", priority = 7)
	public void ItemsPriceView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			if (i == 0) {
				...
				extentTest = report.startTest("Planned ItemPrice Validation");
			...
			if (i == 1) {
				...
				extentTest = report.startTest("Actual ItemPrice Validation");
			...
			if (i == 2) {
				...
				extentTest = report.startTest("Variance ItemPrice Validation");
	...
	@Test(description = "Daily Planning - Store, Customers View", priority = 8)
	...
	@Test(description = "Daily Planning - Store, CPH View", priority = 9)
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\DailyPlanningStore.xml");
