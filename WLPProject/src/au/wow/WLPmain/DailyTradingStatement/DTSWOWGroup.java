...
import au.wow.WLPmain.objects.DailyTradingStatementBusinessUnitsObjects;
...
import au.wow.WLPmain.objects.DailyTradingStatementWOWGroupObjects;
...
public class DTSWOWGroup extends TestBase {
	protected Logger log = LogManager.getLogger(DTSWOWGroup.class);
	TestStatus status;
	...
	DailyTradingStatementWOWGroupObjects objDailyTradingStatementWOWGroupObjects;
	...
	List<List<Object>> DBPlndValWkToDt, DBActlValWkToDt, DBLYValWkToDt, DBPlndValTtlWkToDt, DBActlTtlWkToDt,
			...
			ActlValWkToDtOR, ActlValTtlWkToDtOR,AllowedwagesTtl,Allowedwages;
	...
	//////////// Sales ///////////////
	@Test(description = "Daily Trading Statement - WOWGroup, Sales Values", priority = 1)
	public void SalesColumnValidation() throws Exception {
		...
		System.out.println("Entering into TestCase : DTS WOWGroup - Sales View");
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.screenToViewDailyTrading, "Woolworths Group");

	
			waitFor(200);
			
		//pageWeeklyPlanningPO.clickButton(objDailyTradingStatementObjects.ShowButton, extentTest, "Woolworths Group");
		/*pageWeeklyPlanningPO.verifyPageName(extentTest, objWeeklyPlanningStoreObjects.DataFrame,
				objWeeklyPlanningStoreObjects.pageName, getContext().getStringProperty("DTSWOWGroup"));*/
		...
		String PlannedSalesTotal = data.getText("PlannedSales");
		...
		PlndVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Sales",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayPlndSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.ThursdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.FridayPlndSales,
				objDailyTradingStatementWOWGroupObjects.SaturdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.SundayPlndSales, objDailyTradingStatementWOWGroupObjects.Table,
				objDailyTradingStatementWOWGroupObjects.Department);
		PlndValTtl = pageDailyTradingStatementGroupPO.DayWiseTotal("Sales",
				...
				objDailyTradingStatementWOWGroupObjects.SaturdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.SundayPlndSales, objDailyTradingStatementWOWGroupObjects.Table,
				objDailyTradingStatementWOWGroupObjects.WOWTotal);
		...
		String ActualSalesTotal = data.getText("PastWeekActualSales");
		...
		if (WeekValue.contains("Current") ) {
			...
			String ActualSalesTotal = data.getText("CurrentWeekActualSales");
			DBActlTtl = sql.CLRexecuteQuery(getContext(),
					ActualSalesTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		ActlVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Sales",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayActlSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayActlSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayActlSales,
				objDailyTradingStatementWOWGroupObjects.ThursdayActlSales,
				objDailyTradingStatementWOWGroupObjects.FridayActlSales,
				objDailyTradingStatementWOWGroupObjects.SaturdayActlSales,
				objDailyTradingStatementWOWGroupObjects.SundayActlSales, objDailyTradingStatementWOWGroupObjects.Table,
				objDailyTradingStatementWOWGroupObjects.Department);
		...
		String LYSalesTotal = data.getText("PastWeekLYsales");
		...
		if (WeekValue.contains("Current") ) {
			...
			String LYSalesTotal = data.getText("CurrentWeekLYsales");
			DBLYValTtl = sql.CLRexecuteQuery(getContext(),
					LYSalesTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		LYVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Sales",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayLYSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayLYSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayLYSales,
				objDailyTradingStatementWOWGroupObjects.ThursdayLYSales,
				objDailyTradingStatementWOWGroupObjects.FridayLYSales,
				objDailyTradingStatementWOWGroupObjects.SaturdayLYSales,
				objDailyTradingStatementWOWGroupObjects.SundayLYSales, objDailyTradingStatementWOWGroupObjects.Table,
				objDailyTradingStatementWOWGroupObjects.Department);
		...
		String PlannedSalesWkToDtTotal = data.getText("PlannedSalesWkToDt");
		...
		PlndValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Sales",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDatePlndSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		PlndValTtlWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotal("Sales",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDatePlndSales,
				objDailyTradingStatementWOWGroupObjects.Table, objDailyTradingStatementWOWGroupObjects.WOWTotal);
		...
		String ActualSalesWkToDtTotal = data.getText("PastWeekActualSalesWkToDt");
		...
		if (WeekValue.contains("Current") ) {
			...
			String ActualSalesWkToDtTotal = data.getText("CurrentWeekActualSalesWkToDt");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualSalesWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		ActlValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Sales",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateActlSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		String LYSalesWkToDtTotal = data.getText("PastWeekLYSalesWkToDt");
		...
		if (WeekValue.contains("Current") ) {
			...
			String LYSalesWkToDtTotal = data.getText("CurrentWeekLYSalesWkToDt");
			DBLYValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					LYSalesWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		LYValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Sales",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateLYSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		String VarSalesWkToDtTotal = data.getText("PastWeekVarSalesWkToDt");
		...
		if (WeekValue.contains("Current") ) {
			...
			String VarSalesWkToDtTotal = data.getText("CurrentWeekVarSalesWkToDt");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
					VarSalesWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		VarWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Sales",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateVarSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (OptionToView.contains("Budget")) {
			...
			String BudgetSalesTotal = data.getText("BudgetSales");
			...
			BdgtSls = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Sales",
					objDailyTradingStatementWOWGroupObjects.DataFrame,
					objDailyTradingStatementWOWGroupObjects.BudgetSales,
					objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
			BdgtSlsTtl = pageDailyTradingStatementGroupPO.WeekToDateTotal("Sales",
					objDailyTradingStatementWOWGroupObjects.DataFrame,
					objDailyTradingStatementWOWGroupObjects.BudgetSales, objDailyTradingStatementWOWGroupObjects.Table,
					objDailyTradingStatementWOWGroupObjects.WOWTotal);
		...
		if (OptionToView.contains("Forecast")) {
			...
			String ForecastSalesTotal = data.getText("ForecastSales");
			DBBdgtSlsTtl = sql.CLRexecuteQuery(getContext(),
		...
		String EstimatedFcstSalesTotal = data.getText("PastWeekEstimatedFcstSales");
		...
		if (WeekValue.contains("Current") ) {
			...
			String EstimatedFcstSalesTotal = data.getText("CurrentWeekEstimatedFcstSales");
			DBEstFcstSlsTtl = sql.CLRexecuteQuery(getContext(),
					EstimatedFcstSalesTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		EstFcstSls = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Sales",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.EstForecastSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		EstFcstSlsTtl = pageDailyTradingStatementGroupPO.WeekToDateTotal("Sales",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.EstForecastSales, objDailyTradingStatementWOWGroupObjects.Table,
				objDailyTradingStatementWOWGroupObjects.WOWTotal);
		...
		if (OptionToView.contains("Budget")) {
			...
			String VarSalesTotal = data.getText("PastWeekVarSales");
			...
			if (WeekValue.contains("Current") ) {
				...
				String VarSalesTotal = data.getText("CurrentWeekVarSales");
				DBVarSalesTtl = sql.CLRexecuteQuery(getContext(),
						VarSalesTotal.replace("store", getContext().getStringProperty("store"))
								.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
								.replace("Region", getContext().getStringProperty("Region"))
			...
			VarSls = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Sales",
					objDailyTradingStatementWOWGroupObjects.DataFrame,
					objDailyTradingStatementWOWGroupObjects.VarBudgetSales,
					objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (OptionToView.contains("Forecast")) {
			...
			String ForecastVarSalesTotal = data.getText("PastWeekForecastVarSales");
			DBVarSalesTtl = sql.CLRexecuteQuery(getContext(),
			...
			if (WeekValue.contains("Current") ) {
				...
				String ForecastVarSalesTotal = data.getText("CurrentWeekForecastVarSales");
				DBVarSalesTtl = sql.CLRexecuteQuery(getContext(),
						ForecastVarSalesTotal.replace("store", getContext().getStringProperty("store"))
								.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
								.replace("Region", getContext().getStringProperty("Region"))
		...
		//Allowed Wages Column Validation
		...
		String AllowedWgsTtl = data.getText("PastWeekAllowedWages");
		...
		if (WeekValue.contains("Current") ) {
			...
			String AllowedWgsTtl = data.getText("CurrentWeekAllowedWages");
			DBAllowedWgsTtl = sql.CLRexecuteQuery(getContext(),
					AllowedWgsTtl.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		Allowedwages = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Wages",
				objDailyTradingStatementWOWGroupObjects.DataFrame,objDailyTradingStatementWOWGroupObjects.AllowedWages,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
	...
	///////////// SMS ///////////////
/*	@Test(description = "Daily Trading Statement - WOWGroup, SMS Values", priority = 2)
	public void SMSColumnValidation() throws Exception {
		...
		String PlannedSMSTotal = data.getText("PlannedSMS");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
		...
		PlndVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("SMS",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayPlndSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayPlndSales,
		...
		if (WeekValue.contains("Past")) {
			...
			String ActualSMSTotal = data.getText("PastWeekActualSMS");
		...
		if (WeekValue.contains("Current") ) {
			...
			String CurrentActualSMSTotal = data.getText("CurrentWeekActual");
			DBActlValTtl = sql.CLRexecuteQuery(getContext(),
		...
		ActlVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("SMS",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayActlSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayActlSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayActlSales,
		...
		String PlannedSMSWkToDtTotal = data.getText("PlannedSMSWkToDt");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		PlndValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("SMS",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDatePlndSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
	...
	/*	Report_AddStep("testcase", " ACTUAL SMS - WEEK TO DATE DATA", "", "", "");
		...
		ActlValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("SMS",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateActlSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
...
*/
	//////////// OR ///////////////
	@Test(description = "Daily Trading Statement - WOWGroup, OR Values", priority = 3)
	public void ORColumnValidation() throws Exception {
		...
		String PlannedORTotal = data.getText("PlannedOR");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
		...
		PlndVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("OR", objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayPlndSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.ThursdayPlndSales,
				...
				objDailyTradingStatementWOWGroupObjects.SundayPlndSales, objDailyTradingStatementWOWGroupObjects.Table,
				objDailyTradingStatementWOWGroupObjects.Department);
		PlndValTtl = pageDailyTradingStatementGroupPO.DayWiseTotal("OR",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayPlndSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayPlndSales,
	...
	/*	Report_AddStep("testcase", " ACTUAL OR - WEEK WISE DATA", "", "", "");
		...
		if (WeekValue.contains("Past")) {
			...
			String ActualORTotal = data.getText("PastWeekActualOR");
		...
		ActlVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("OR", objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayActlSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayActlSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayActlSales,
				objDailyTradingStatementWOWGroupObjects.ThursdayActlSales,
				...
				objDailyTradingStatementWOWGroupObjects.SundayActlSales, objDailyTradingStatementWOWGroupObjects.Table,
				objDailyTradingStatementWOWGroupObjects.Department);
		ActlValTtl = pageDailyTradingStatementGroupPO.DayWiseTotal("OR",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayActlSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayActlSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayActlSales,
		...
		String PlannedORWkToDtTotal = data.getText("PlannedORWkToDt");
		...
		PlndValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("OR",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDatePlndSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
	...
	/*	Report_AddStep("testcase", " ACTUAL OR - WEEK TO DATE DATA", "", "", "");
		...
		ActlValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("OR",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateActlSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
	...
	//////////// Hours ///////////////
	@Test(description = "Daily Trading Statement - WOWGroup, Hours Values", priority = 4)
	public void HoursColumnValidation() throws Exception {
		...
		String PlannedHoursTotal = data.getText("PlannedHours");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
				PlannedHoursTotal.replace("store", getContext().getStringProperty("store"))
						...
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtl);
		PlndVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Hours",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayPlndSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayPlndSales,
		...
		String ActualHoursTotal = data.getText("PastWeekActualHours");
		DBActlTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String ActualHoursTotal = data.getText("CurrentWeekActualHours");
			DBActlTtl = sql.CLRexecuteQuery(getContext(),
					ActualHoursTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		ActlVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Hours",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayActlSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayActlSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayActlSales,
		...
		String PlannedHoursWkToDtTotal = data.getText("PlannedHoursWkToDt");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		PlndValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Hours",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDatePlndSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (WeekValue.contains("Past") ) {
			...
			String ActualHoursWkToDtTotal = data.getText("PastWeekActualHoursWkToDt");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current")) {
			...
			String CurrentActualHoursWkToDtTotal = data.getText("CurrentWeekActualHoursWkToDt");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		ActlValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Hours",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateActlSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (WeekValue.contains("Past") ) {
			...
			String VarHoursWkToDtTotal = data.getText("PastWeekVarHoursWkToDt");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current")) {
			...
			String CurrentVarHoursWkToDtTotal = data.getText("CurrentWeekVarHoursWkToDt");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
		...
		VarWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Hours",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateVarSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
	...
	//////////// ITEMS ///////////////
/*	@Test(description = "Daily Trading Statement - WOWGroup, Items Values", priority = 5)
	public void ItemsColumnValidation() throws Exception {
		...
		String PlannedItemsTotal = data.getText("PlannedItems");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
		...
		PlndVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Items",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayPlndSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayPlndSales,
		...
		String ActualItemsTotal = data.getText("PastWeekActualItems");
		DBActlTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String ActualItemsTotal = data.getText("CurrentWeekActualItems");
			DBActlTtl = sql.CLRexecuteQuery(getContext(),
					ActualItemsTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		ActlVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Items",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayActlSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayActlSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayActlSales,
		...
		String LYItemsTotal = data.getText("PastWeekLYItems");
		DBLYValTtl = sql.CLRexecuteQuery(getContext(),
		...
		String LYItemsTotal = data.getText("CurrentWeekLYItems");
		DBLYValTtl = sql.CLRexecuteQuery(getContext(),
				LYItemsTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
						.replace("Region", getContext().getStringProperty("Region"))
		...
		LYVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Items",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayLYSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayLYSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayLYSales,
		...
		String PlannedItemsWkToDtTotal = data.getText("PlannedItemsWkToDt");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		PlndValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Items",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDatePlndSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		String ActualItemsWkToDtTotal = data.getText("PastWeekActualItemsWkToDt");
		DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String ActualItemsWkToDtTotal = data.getText("CurrentWeekActualItemsWkToDt");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualItemsWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		ActlValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Items",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateActlSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		String LYItemsWkToDtTotal = data.getText("PastWeekLYItemsWkToDt");
		DBLYValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String LYItemsWkToDtTotal = data.getText("CurrentWeekLYItemsWkToDt");
			DBLYValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					LYItemsWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		LYValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Items",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateLYSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		String VarItemsWkToDtTotal = data.getText("PastWeekVarItemsWkToDt");
		DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String VarItemsWkToDtTotal = data.getText("CurrentWeekVarItemsWkToDt");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
					VarItemsWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		VarWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Items",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateVarSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
	...
	//////////// CUSTOMERS ///////////////
	@Test(description = "Daily Trading Statement - WOWGroup, Customers Values", priority = 6)
	public void CustomersColumnValidation() throws Exception {
		...
		String PlannedCustomersTotal = data.getText("PlannedCustomers");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
		...
		PlndVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Customers",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayPlndSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayPlndSales,
		...
		String ActualCustomersTotal = data.getText("PastWeekActualCustomers");
		DBActlTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String ActualCustomersTotal = data.getText("CurrentWeekActualCustomers");
			DBActlTtl = sql.CLRexecuteQuery(getContext(),
					ActualCustomersTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		ActlVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Customers",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayActlSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayActlSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayActlSales,
		...
		String LYCustomersTotal = data.getText("PastWeekLYCustomers");
		DBLYValTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String LYCustomersTotal = data.getText("CurrentWeekLYCustomers");
			DBLYValTtl = sql.CLRexecuteQuery(getContext(),
					LYCustomersTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		LYVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Customers",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayLYSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayLYSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayLYSales,
		...
		String PlannedCustomersWkToDtTotal = data.getText("PlannedCustomersWkToDt");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		PlndValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Customers",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDatePlndSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		String ActualCustomersWkToDtTotal = data.getText("PastWeekActualCustomersWkToDt");
		DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String ActualCustomersWkToDtTotal = data.getText("CurrentWeekActualCustomersWkToDt");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualCustomersWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		ActlValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Customers",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateActlSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		String LYCustomersWkToDtTotal = data.getText("PastWeekLYCustomersWkToDt");
		DBLYValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String LYCustomersWkToDtTotal = data.getText("CurrentWeekLYCustomersWkToDt");
			DBLYValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					LYCustomersWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		LYValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Customers",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateLYSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		String VarCustomersWkToDtTotal = data.getText("PastWeekVarCustomersWkToDt");
		DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String VarCustomersWkToDtTotal = data.getText("CurrentWeekVarCustomersWkToDt");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
					VarCustomersWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		VarWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Customers",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateVarSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
	...
	//////////// WAGES PERCENTAGE ///////////////
	@Test(description = "Daily Trading Statement - WOWGroup, Wages Values", priority = 7)
	public void WagesPercentageColumnValidation() throws Exception {
		...
		String PlannedWagesPercentageTotal = data.getText("PlannedWagesPercentage");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
		...
		PlndVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("WagesPercentage",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayPlndSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayPlndSales,
		...
		String ActualWagesPercentageTotal = data.getText("PastWeekActualWagesPercentage");
		DBActlTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String ActualWagesPercentageTotal = data.getText("CurrentWeekActualWagesPercentage");
			DBActlTtl = sql.CLRexecuteQuery(getContext(),
					ActualWagesPercentageTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		ActlVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("WagesPercentage",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayActlSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayActlSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayActlSales,
		...
		String PlannedWagesPercentageWkToDtTotal = data.getText("PlannedWagesPercentageWkToDt");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		PlndValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("WagesPercentage",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDatePlndSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (WeekValue.contains("Past") ) {
			...
			String ActualWagesPercentageWkToDtTotal = data.getText("PastWeekActualWagesPercentageWkToDt");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current")) {
			...
			String CurrentActualWagesPercentageWkToDtTotal = data.getText("CurrentWeekActualWagesPercentageWkToDt");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		ActlValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("WagesPercentage",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateActlSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (WeekValue.contains("Past") ) {
			...
			String VarWagesPercentageWkToDtTotal = data.getText("PastWeekVarWagesPercentageWkToDt");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current")) {
			...
			String CurrentVarWagesPercentageWkToDtTotal = data.getText("CurrentWeekVarWagesPercentageWkToDt");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
		...
		VarWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("WagesPercentage",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateVarSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (OptionToView.contains("Budget")) {
			...
			String BudgetWagePercentageTotal = data.getText("BudgetWagePercentage");
			...
			BdgtWg = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("WagesPercentage",
					objDailyTradingStatementWOWGroupObjects.DataFrame,
					objDailyTradingStatementWOWGroupObjects.BudgetSales,
					objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (OptionToView.contains("Forecast")) {
			...
			String ForecastWagePercentageTotal = data.getText("ForecastWagePercentage");
			DBBdgtWgTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Past") ) {
			...
			String EstimatedFcstWagePrcntTotal = data.getText("PastWeekEstimatedFcstWagePrcnt");
		...
		if (WeekValue.contains("Current")) {
			...
			String CurrentEstimatedFcstWagePrcntTotal = data.getText("CurrentWeekEstimatedFcstWagePrcnt");
			DBEstFcstWgsPrcntTtl = sql.CLRexecuteQuery(getContext(),
		...
		EstFcstWgsPrcnt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("WagesPercentage",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.EstForecastSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (OptionToView.contains("Budget")) {
			...
			if (WeekValue.contains("Past") ) {
				...
				String VarWagesPrecentageTotal = data.getText("PastWeekVarWagesPrecentage");
			...
			if (WeekValue.contains("Current")) {
				...
				String CurrentVarWagesPrecentageTotal = data.getText("CurrentWeekVarWagesPrecentage");
				DBVarWagesPrcntTtl = sql.CLRexecuteQuery(getContext(),
			...
			VarWagesPrcnt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("WagesPercentage",
					objDailyTradingStatementWOWGroupObjects.DataFrame,
					objDailyTradingStatementWOWGroupObjects.VarBudgetSales,
					objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (OptionToView.contains("Forecast")) {
			...
			if (WeekValue.contains("Past") ) {
				...
				String ForecastVarWagesPrecentageTotal = data.getText("PastWeekForecastVarWagesPrecentage");
				DBVarWagesPrcntTtl = sql.CLRexecuteQuery(getContext(),
			...
			if (WeekValue.contains("Current")) {
				...
				String CurrentForecastVarWagesPrecentageTotal = data.getText("CurrentWeekForecastVarWagesPrecentage");
				DBVarWagesPrcntTtl = sql.CLRexecuteQuery(getContext(),
	...
	//////////// WAGES ///////////////
	@Test(description = "Daily Trading Statement - WOWGroup, Wages Values", priority = 8)
	public void WagesColumnValidation() throws Exception {
		...
		String PlannedWagesTotal = data.getText("PlannedWages");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
		...
		PlndVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Wages",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayPlndSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayPlndSales,
		...
		String ActualWagesTotal = data.getText("PastWeekActualWages");
		DBActlTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String ActualWagesTotal = data.getText("CurrentWeekActualWages");
			DBActlTtl = sql.CLRexecuteQuery(getContext(),
					ActualWagesTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		ActlVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Wages",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayActlSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayActlSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayActlSales,
		...
		String LYWagesTotal = data.getText("PastWeekLYWages");
		DBLYValTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current") ) {
			...
			String LYWagesTotal = data.getText("CurrentWeekLYWages");
			DBLYValTtl = sql.CLRexecuteQuery(getContext(),
					LYWagesTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek"))
							.replace("Region", getContext().getStringProperty("Region"))
		...
		LYVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("Wages",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayLYSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayLYSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayLYSales,
		...
		String PlannedWagesWkToDtTotal = data.getText("PlannedWagesWkToDt");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		PlndValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Wages",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDatePlndSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (WeekValue.contains("Past") ) {
			...
			String ActualWagesWkToDtTotal = data.getText("PastWeekActualWagesWkToDt");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current")) {
			...
			String CurrentActualWagesWkToDtTotal = data.getText("CurrentWeekActualWagesWkToDt");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		ActlValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Wages",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateActlSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (WeekValue.contains("Past") ) {
			...
			String LYWagesWkToDtTotal = data.getText("PastWeekLYWagesWkToDt");
			DBLYValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current")) {
			...
			String CurrentLYWagesWkToDtTotal = data.getText("CurrentWeekLYWagesWkToDt");
			DBLYValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		LYValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Wages",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateLYSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (WeekValue.contains("Past") ) {
			...
			String VarWagesWkToDtTotal = data.getText("PastWeekVarWagesWkToDt");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current")) {
			...
			String CurrentVarWagesWkToDtTotal = data.getText("CurrentWeekVarWagesWkToDt");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
		...
		VarWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Wages",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateVarSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (OptionToView.contains("Budget")) {
			...
			String BudgetWagesTotal = data.getText("BudgetWages");
			DBBdgtSlsTtl = sql.CLRexecuteQuery(getContext(),
			...
			BdgtSls = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Wages",
					objDailyTradingStatementWOWGroupObjects.DataFrame,
					objDailyTradingStatementWOWGroupObjects.BudgetSales,
					objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (OptionToView.contains("Forecast")) {
			...
			String ForecastWagesTotal = data.getText("ForecastWages");
			DBBdgtSlsTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Past") ) {
			...
			String EstimatedFcstWageTotal = data.getText("PastWeekEstimatedFcstWage");
		...
		if (WeekValue.contains("Current")) {
			...
			String CurrentEstimatedFcstWageTotal = data.getText("CurrentWeekEstimatedFcstWage");
			DBEstFcstWgsTtl = sql.CLRexecuteQuery(getContext(),
		...
		EstFcstWgs = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Wages",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.EstForecastSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (OptionToView.contains("Budget")) {
			...
			if (WeekValue.contains("Past")) {
				...
				String VarWagesTotal = data.getText("PastWeekVarWages");
			...
			if (WeekValue.contains("Current")) {
				...
				String CurrentVarWagesTotal = data.getText("CurrentWeekVarWages");
				DBVarWagesTtl = sql.CLRexecuteQuery(getContext(),
			...
			VarWages = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("Wages",
					objDailyTradingStatementWOWGroupObjects.DataFrame,
					objDailyTradingStatementWOWGroupObjects.VarBudgetSales,
					objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (OptionToView.contains("Forecast")) {
			...
			if (WeekValue.contains("Past") ) {
				...
				String ForecastVarWagesTotal = data.getText("PastWeekForecastVarWages");
				DBVarWagesTtl = sql.CLRexecuteQuery(getContext(),
			...
			if (WeekValue.contains("Current")) {
				...
				String CurrentForecastVarWagesTotal = data.getText("CurrentWeekForecastVarWages");
				DBVarWagesTtl = sql.CLRexecuteQuery(getContext(),
	...
	//////////// CPH ///////////////
	@Test(description = "Daily Trading Statement - WOWGroup, CPH Values", priority = 9)
	public void CPHColumnValidation() throws Exception {
		...
		String PlannedCPHTotal = data.getText("PlannedCPH");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
		...
		PlndVal = pageDailyTradingStatementGroupPO.DayWiseWowScreen("CPH",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.MondayPlndSales,
				objDailyTradingStatementWOWGroupObjects.TuesdayPlndSales,
				objDailyTradingStatementWOWGroupObjects.WednesdayPlndSales,
		...
		String PlannedCPHWkToDtTotal = data.getText("PlannedCPHWkToDt");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		PlndValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("CPH",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDatePlndSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (WeekValue.contains("Past") ) {
			...
			String ActualCPHWkToDtTotal = data.getText("PastWeekActualCPHWkToDt");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current")) {
			...
			String CurrentActualCPHWkToDtTotal = data.getText("CurrentWeekActualCPHWkToDt");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
		...
		ActlValWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("CPH",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateActlSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
		...
		if (WeekValue.contains("Past") ) {
			...
			String VarCPHWkToDtTotal = data.getText("PastWeekVarCPHWkToDt");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
		...
		if (WeekValue.contains("Current")) {
			...
			String CurrentVarCPHWkToDtTotal = data.getText("CurrentWeekVarCPHWkToDt");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
		...
		VarWkToDt = pageDailyTradingStatementGroupPO.WeekToDateTotalforWowscreen("CPH",
				objDailyTradingStatementWOWGroupObjects.DataFrame,
				objDailyTradingStatementWOWGroupObjects.WeekToDateVarSales,
				objDailyTradingStatementWOWGroupObjects.Department, objDailyTradingStatementWOWGroupObjects.Table);
	...
	public void setUpItemPrice(Method m, ITestContext testcontext) throws IOException {
		...
		objDailyTradingStatementWOWGroupObjects = PageFactory.initElements(this.getDriver(),
				DailyTradingStatementWOWGroupObjects.class);
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\DailyTradingStatementWOWGroup.xml");
