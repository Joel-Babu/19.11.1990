...
public class DTS_Store extends TestBase {
	...
	List<List<Object>> PlndValWkToDt, ActlValWkToDt, LYValWkToDt, PlndValTtlWkToDt, ActlValTtlWkToDt, LYValTtlWkToDt,
			VarWkToDt, ORWkToDt, VarTtlWkToDt, ORTtlWkToDt;
	List<List<Object>> DBPlndVal, DBActlVal, DBLYVal, DBPlndValTtl, DBActlTtl, DBLYValTtl, DBBdgtSls, DBBdgtSlsTtl,
			...
			EstFcstWgsPrcntTtl, DBVarSales, DBVarSalesTtl, VarSls, VarSalesTtl, DBVarWages, DBVarWagesTtl, VarWages,
			VarWagesTtl, DBVarWagesPrcnt, DBVarWagesPrcntTtl, VarWagesPrcnt, VarWagesPrcntTtl, DBActlValTtl,
			DBActlValTtlWkToDt, DBActlORVal, DBActlORValTtl, ActlValOR, ActlValORTtl, ActlValWkToDtOR,
			ActlValTtlWkToDtOR, DBActlValWkToDtOR, DBActlValTtlWkToDtOR,DBVarValWkToDt, VarValWkToDt,DBVarlValTtlWkToDt, VarValTtlWkToDt;
	List<List<Object>> DBPlndValWkToDt, DBActlValWkToDt, DBLYValWkToDt, DBPlndValTtlWkToDt, DBActlTtlWkToDt,
			DBLYValTtlWkToDt, DBVarWkToDt, DBORWkToDt, DBVarWkToDtTtl, DBORWkToDtTtl,AllowedwagesTtl,Allowedwages;
	...
	public void SalesColumnValidation() throws Exception {
	  ...
	  Report_AddStep("testcase", " PLANNED SALES - WEEK WISE DATA", "", "", "");
		...
		DBPlndVal = sql.CLRexecuteQuery(getContext(),
				PlannedSales.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		...
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
				PlannedSalesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtl);

		PlndVal = pageDailyTradingStatementStorePO.PastUIResults("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.MondayPlndSales, objDailyTradingStatementObjects.TuesdayPlndSales,
				objDailyTradingStatementObjects.WednesdayPlndSales, objDailyTradingStatementObjects.ThursdayPlndSales,
				objDailyTradingStatementObjects.ThursdayPlndSalesWhite, DailyTradingStatementObjects.FridayPlndSales,
				objDailyTradingStatementObjects.FridayPlndSalesWhite, objDailyTradingStatementObjects.SaturdayPlndSales,
				objDailyTradingStatementObjects.SaturdayPlndSalesWhite, objDailyTradingStatementObjects.SundayPlndSales,
				objDailyTradingStatementObjects.SundayPlndSalesWhite);
		PlndValTtl = pageDailyTradingStatementStorePO.PastUITotal("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.MondayPlndSales, objDailyTradingStatementObjects.TuesdayPlndSales,
				objDailyTradingStatementObjects.WednesdayPlndSales, objDailyTradingStatementObjects.ThursdayPlndSales,
				objDailyTradingStatementObjects.ThursdayPlndSalesWhite, objDailyTradingStatementObjects.FridayPlndSales,
				objDailyTradingStatementObjects.FridayPlndSalesWhite, objDailyTradingStatementObjects.SaturdayPlndSales,
				objDailyTradingStatementObjects.SaturdayPlndSalesWhite, objDailyTradingStatementObjects.SundayPlndSales,
				objDailyTradingStatementObjects.SundayPlndSalesWhite, objDailyTradingStatementObjects.Table);
		...
		DBActlTtl = sql.CLRexecuteQuery(getContext(),
				ActualSalesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		...
		ActlVal = pageDailyTradingStatementStorePO.DayWiseUIData("Sales", "ActualSales",
				objDailyTradingStatementObjects);
		ActlValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Sales", "ActualSales",
				objDailyTradingStatementObjects);
		...
		LYVal = pageDailyTradingStatementStorePO.DayWiseUIData("Sales", "LYSales", objDailyTradingStatementObjects);
		LYValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Sales", "LYSales", objDailyTradingStatementObjects);

		pageDailyTradingStatementStorePO.DTSCompareValues(extentTest, DBLYVal, LYVal);
		pageDailyTradingStatementStorePO.DTSCompareValuesTotal(extentTest, DBLYValTtl, LYValTtl); 
		...
		DBPlndValWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedSalesWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		...
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedSalesWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtlWkToDt);

		PlndValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
		PlndValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
		...
		DBActlValWkToDt = sql.CLRexecuteQuery(getContext(),
				ActualSalesWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		...
		DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
				ActualSalesWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		...
		ActlValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		ActlValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		...
		LYValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateLYSales);
		LYValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateLYSales);

		pageWeeklyPlanningPO.CompareValues(extentTest, DBLYValWkToDt, LYValWkToDt);
		pageWeeklyPlanningPO.CompareValues(extentTest, DBLYValTtlWkToDt, LYValTtlWkToDt);
		...
		DBVarWkToDt = sql.CLRexecuteQuery(getContext(),
				VarSalesWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		...
		DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
				VarSalesWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		...
		VarWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
		VarTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
		...
		DBAllowedWgs = sql.CLRexecuteQuery(getContext(),
				AllowedWgs.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")).replace("Region", getContext().getStringProperty("Region")));
		...
		DBAllowedWgsTtl = sql.CLRexecuteQuery(getContext(),
				AllowedWgsTtl.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")).replace("Region", getContext().getStringProperty("Region")));
		...
		Allowedwages = pageDailyTradingStatementStorePO.WeekToDateData("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.AllowedWages);
		AllowedwagesTtl = pageDailyTradingStatementStorePO.WeekToDateTotal("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.AllowedWages);
	...
	public void SMSColumnValidation() throws Exception {
		...
		DBPlndVal = sql.CLRexecuteQuery(getContext(),
				PlannedSMS.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndVal);

		String PlannedSMSTotal = data.getText("PlannedSMSTotal");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
				PlannedSMSTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtl);

		PlndVal = pageDailyTradingStatementStorePO.DayWiseUIData("SMS", "PlannedValue",
				objDailyTradingStatementObjects);
		PlndValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("SMS", "PlannedValue",
				objDailyTradingStatementObjects);
	  ...
	  /*  Report_AddStep("testcase", " ACTUAL SMS - WEEK WISE DATA", "", "", "");
		...
		if (WeekValue.contains("Past")) {
			...
			DBActlVal = sql.CLRexecuteQuery(getContext(),
					ActualSMS.replace("store", getContext().getStringProperty("store"))
							...
							.replace("Year", getContext().getStringProperty("FinYr")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlVal);
		...
		if (WeekValue.contains("Current") ) {
			...
			DBActlVal = sql.CLRexecuteQuery(getContext(),
					CurrentActualSMS.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk"))
							.replace("Year", getContext().getStringProperty("FinYr")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlVal);
			...
			DBActlValTtl = sql.CLRexecuteQuery(getContext(),
					CurrentActualSMSTotal.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk"))
							.replace("Year", getContext().getStringProperty("FinYr")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlValTtl);
		...
		ActlVal = pageDailyTradingStatementStorePO.DayWiseUIData("SMS", "ActualValue", objDailyTradingStatementObjects);
		ActlValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("SMS", "ActualValue",
				objDailyTradingStatementObjects);
		...
		DBPlndValWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedSMSWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValWkToDt);

		String PlannedSMSWkToDtTotal = data.getText("PlannedSMSWkToDtTotal");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedSMSWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtlWkToDt);

		PlndValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("SMS", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
		PlndValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("SMS", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
	...
	/*	Report_AddStep("testcase", " ACTUAL SMS - WEEK TO DATE DATA", "", "", "");
		...
		if (WeekValue.contains("Past")) {
			...
			DBActlValWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualSMSWkToDt.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk"))
							.replace("Year", getContext().getStringProperty("FinYr")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlValWkToDt);
			...
			DBActlValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualSMSWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk"))
							.replace("Year", getContext().getStringProperty("FinYr")).replace("Division", getContext().getStringProperty("Division")));
		...
		if (WeekValue.contains("Current") ) {
			...
			DBActlValWkToDt = sql.CLRexecuteQuery(getContext(),
					CurrentActualSMSWkToDt.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk"))
							.replace("Year", getContext().getStringProperty("FinYr")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlValWkToDt);
		...
		ActlValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("SMS", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		ActlValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("SMS", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		...
		// Week to Date - SMS Variance 
				...
				if (WeekValue.contains("Past")) {
					...
					DBVarValWkToDt = sql.CLRexecuteQuery(getContext(),
							ActualSMSWkToDt.replace("store", getContext().getStringProperty("store"))
									.replace("FinWk", getContext().getStringProperty("FinWk")).replace("Week",
											getContext().getStringProperty("SelectFiscalWeek"))
									.replace("Year", getContext().getStringProperty("FinYr")).replace("Division", getContext().getStringProperty("Division")));
					System.out.println("DB Value: " + DBVarValWkToDt);

					String ActualSMSWkToDtTotal = data.getText("PastWeekVarSMSWkToDtTotal");
					DBVarlValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
							ActualSMSWkToDtTotal.replace("store", getContext().getStringProperty("store"))
									.replace("FinWk", getContext().getStringProperty("FinWk")).replace("Week",
											getContext().getStringProperty("SelectFiscalWeek"))
									.replace("Year", getContext().getStringProperty("FinYr")).replace("Division", getContext().getStringProperty("Division")));
					System.out.println("DB Value: " + DBVarlValTtlWkToDt );
				}
				if (WeekValue.contains("Current") ) {
				...
				VarValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("SMS", objDailyTradingStatementObjects,
						objDailyTradingStatementObjects.WeekToDateVarSales);
				VarValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("SMS", objDailyTradingStatementObjects,
						objDailyTradingStatementObjects.WeekToDateVarSales);

				pageWeeklyPlanningPO.CompareValueDecimalFields(extentTest, DBVarValWkToDt, VarValWkToDt);
				pageMonthlyPlanningPO.CompareValueDecimalFields(extentTest, DBVarlValTtlWkToDt, VarValTtlWkToDt);	 */
	...
	public void HoursColumnValidation() throws Exception {
		...
		DBPlndVal = sql.CLRexecuteQuery(getContext(),
				PlannedHours.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndVal);

		String PlannedHoursTotal = data.getText("PlannedHoursTotal");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
				PlannedHoursTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtl);

		PlndVal = pageDailyTradingStatementStorePO.DayWiseUIData("Hours", "PlannedValue",
				objDailyTradingStatementObjects);
		PlndValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Hours", "PlannedValue",
				objDailyTradingStatementObjects);
		...
		DBActlTtl = sql.CLRexecuteQuery(getContext(),
				ActualHoursTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBActlTtl);
		}
		if (WeekValue.contains("Current") ) {
		...
		ActlVal = pageDailyTradingStatementStorePO.DayWiseUIData("Hours", "ActualValue",
				objDailyTradingStatementObjects);
		ActlValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Hours", "ActualValue",
				objDailyTradingStatementObjects);
		...
		DBPlndValWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedHoursWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValWkToDt);

		String PlannedHoursWkToDtTotal = data.getText("PlannedHoursWkToDtTotal");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedHoursWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtlWkToDt);

		PlndValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Hours", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
		PlndValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Hours", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
		...
		if (WeekValue.contains("Past") ) {
			...
			DBActlValWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualHoursWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlValWkToDt);

			String ActualHoursWkToDtTotal = data.getText("PastWeekActualHoursWkToDtTotal");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualHoursWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlTtlWkToDt);
		}
		if (WeekValue.contains("Current")) {
		...
		ActlValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Hours", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		ActlValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Hours", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		...
		if (WeekValue.contains("Past") ) {
			...
			DBVarWkToDt = sql.CLRexecuteQuery(getContext(),
					VarHoursWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBVarWkToDt);

			String VarHoursWkToDtTotal = data.getText("PastWeekVarHoursWkToDtTotal");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
					VarHoursWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBVarWkToDtTtl);
		}
		if (WeekValue.contains("Current")) {
			...
			DBVarWkToDt = sql.CLRexecuteQuery(getContext(),
					CurrentVarHoursWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBVarWkToDt);

			String CurrentVarHoursWkToDtTotal = data.getText("CurrentWeekVarHoursWkToDtTotal");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
					CurrentVarHoursWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBVarWkToDtTtl);
		}

		VarWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Hours", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
		VarTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Hours", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
	...
	public void ORColumnValidation() throws Exception {
		...
		DBPlndVal = sql.CLRexecuteQuery(getContext(),
				PlannedOR.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndVal);

		String PlannedORTotal = data.getText("PlannedORTotal");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
				PlannedORTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtl);

		PlndVal = pageDailyTradingStatementStorePO.DayWiseUIData("OR", "PlannedValueOR",
				objDailyTradingStatementObjects);
		PlndValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("OR", "PlannedValueOR",
				objDailyTradingStatementObjects);
	...
	/*	Report_AddStep("testcase", " ACTUAL OR - WEEK WISE DATA", "", "", "");
		...
		if (WeekValue.contains("Current") ) {
			...
			DBActlVal = sql.CLRexecuteQuery(getContext(),
					CurrentActualOR.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk"))
							.replace("Year", getContext().getStringProperty("FinYr"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlVal);
			...
			DBActlValTtl = sql.CLRexecuteQuery(getContext(),
					CurrentActualORTotal.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk"))
							.replace("Year", getContext().getStringProperty("FinYr"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		}

		ActlVal = pageDailyTradingStatementStorePO.DayWiseUIData("OR", "ActualValueOR",
				objDailyTradingStatementObjects);
		ActlValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("OR", "ActualValueOR",
				objDailyTradingStatementObjects);
		...
		DBPlndValWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedORWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValWkToDt);

		String PlannedORWkToDtTotal = data.getText("PlannedORWkToDtTotal");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedORWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtlWkToDt);

		PlndValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("OR", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
		PlndValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("OR", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
	...
	/*	Report_AddStep("testcase", " ACTUAL OR - WEEK TO DATE DATA", "", "", "");
		...
		if (WeekValue.contains("Past")) {
			...
			DBActlValWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualORWkToDt.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk"))
							.replace("Year", getContext().getStringProperty("FinYr"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlValWkToDt);
			...
			DBActlValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualORWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk"))
							.replace("Year", getContext().getStringProperty("FinYr"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlValTtlWkToDt);
		...
		if (WeekValue.contains("Current") ) {
			...
			DBActlValWkToDt = sql.CLRexecuteQuery(getContext(),
					CurrentActualORWkToDt.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk"))
							.replace("Year", getContext().getStringProperty("FinYr"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlValWkToDt);
			...
			DBActlValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					CurrentActualORWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk"))
							.replace("Year", getContext().getStringProperty("FinYr"))
							.replace("Week", getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlValTtlWkToDt);
		...
		ActlValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("OR", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		ActlValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("OR", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);

		pageWeeklyPlanningPO.CompareValueDecimalFields(extentTest, DBActlValWkToDt, ActlValWkToDt);
		pageMonthlyPlanningPO.CompareValueDecimalFields(extentTest, DBActlValTtlWkToDt, ActlValTtlWkToDt);
		
		// Week to Date - OR Variance 
		Report_AddStep("testcase", " VARIANCE OR - WEEK TO DATE DATA", "", "", "");
		extentTest = report.startTest("Variance OR - Week wise");
		
		if (WeekValue.contains("Past")) {
			String ActualSMSWkToDt = data.getText("PastWeekVarORWkToDt");
			DBVarValWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualSMSWkToDt.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk")).replace("Week",
									getContext().getStringProperty("SelectFiscalWeek"))
			...
			String ActualSMSWkToDtTotal = data.getText("PastWeekVarORWkToDtTotal");
			DBVarlValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualSMSWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk")).replace("Week",
									getContext().getStringProperty("SelectFiscalWeek"))
		...
		if (WeekValue.contains("Current") ) {
			String CurrentActualSMSWkToDt = data.getText("CurrentWeekVarORWkToDt");
			DBVarValWkToDt = sql.CLRexecuteQuery(getContext(),
					CurrentActualSMSWkToDt.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk")).replace("Week",
									getContext().getStringProperty("SelectFiscalWeek"))
			...
			String CurrentActualSMSWkToDtTotal = data.getText("CurrentWeekVarORWkToDtTotal");
			DBVarlValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					CurrentActualSMSWkToDtTotal.replace("store", getContext().getStringProperty("store"))
							.replace("FinWk", getContext().getStringProperty("FinWk")).replace("Week",
									getContext().getStringProperty("SelectFiscalWeek"))
		...
		VarValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("OR", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
		VarValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("OR", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
	...
	public void ItemsColumnValidation() throws Exception {
		...
		DBPlndVal = sql.CLRexecuteQuery(getContext(),
				PlannedItems.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndVal);

		String PlannedItemsTotal = data.getText("PlannedItemsTotal");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
				PlannedItemsTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtl);

		PlndVal = pageDailyTradingStatementStorePO.DayWiseUIData("Items", "PlannedValue",
				objDailyTradingStatementObjects);
		PlndValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Items", "PlannedValue",
				objDailyTradingStatementObjects);
		...
		DBActlTtl = sql.CLRexecuteQuery(getContext(),
				ActualItemsTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBActlTtl);
		}
		if (WeekValue.contains("Current") ) {
		...
		ActlVal = pageDailyTradingStatementStorePO.DayWiseUIData("Items", "ActualValue",
				objDailyTradingStatementObjects);
		ActlValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Items", "ActualValue",
				objDailyTradingStatementObjects);
		...
		LYVal = pageDailyTradingStatementStorePO.DayWiseUIData("Items", "LYValue", objDailyTradingStatementObjects);
		LYValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Items", "LYValue", objDailyTradingStatementObjects);
		...
		DBPlndValWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedItemsWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValWkToDt);

		String PlannedItemsWkToDtTotal = data.getText("PlannedItemsWkToDtTotal");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedItemsWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtlWkToDt);

		PlndValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Items", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
		PlndValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Items", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
		...
		DBActlValWkToDt = sql.CLRexecuteQuery(getContext(),
				ActualItemsWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBActlValWkToDt);

		String ActualItemsWkToDtTotal = data.getText("PastWeekActualItemsWkToDtTotal");
		DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
				ActualItemsWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBActlTtlWkToDt);
		}
		if (WeekValue.contains("Current") ) {
		...
		ActlValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Items", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		ActlValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Items", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		...
		LYValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Items", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateLYSales);
		LYValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Items", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateLYSales);
		...
		DBVarWkToDt = sql.CLRexecuteQuery(getContext(),
				VarItemsWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBVarWkToDt);

		String VarItemsWkToDtTotal = data.getText("PastWeekVarItemsWkToDtTotal");
		DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
				VarItemsWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBVarWkToDtTtl);
		}
		...
		VarWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Items", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
		VarTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Items", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
	...
	//////////// CUSTOMERS ///////////////
	@Test(description = "Daily Trading Statement - Store, Customers Values", priority = 6)
	public void CustomersColumnValidation() throws Exception {
		...
		DBPlndVal = sql.CLRexecuteQuery(getContext(),
				PlannedCustomers.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndVal);

		String PlannedCustomersTotal = data.getText("PlannedCustomersTotal");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
				PlannedCustomersTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtl);

		PlndVal = pageDailyTradingStatementStorePO.DayWiseUIData("Customers", "PlannedValue",
				objDailyTradingStatementObjects);
		PlndValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Customers", "PlannedValue",
				objDailyTradingStatementObjects);
		...
		DBActlTtl = sql.CLRexecuteQuery(getContext(),
				ActualCustomersTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBActlTtl);
		}
		if (WeekValue.contains("Current") ) {
		...
		ActlVal = pageDailyTradingStatementStorePO.DayWiseUIData("Customers", "ActualValue",
				objDailyTradingStatementObjects);
		ActlValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Customers", "ActualValue",
				objDailyTradingStatementObjects);
		...
		LYVal = pageDailyTradingStatementStorePO.DayWiseUIData("Customers", "LYValue", objDailyTradingStatementObjects);
		LYValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Customers", "LYValue",
				objDailyTradingStatementObjects);
		...
		DBPlndValWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedCustomersWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValWkToDt);

		String PlannedCustomersWkToDtTotal = data.getText("PlannedCustomersWkToDtTotal");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedCustomersWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtlWkToDt);

		PlndValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Customers", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
		PlndValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Customers",
				objDailyTradingStatementObjects, objDailyTradingStatementObjects.WeekToDatePlndSales);
		...
		DBActlValWkToDt = sql.CLRexecuteQuery(getContext(),
				ActualCustomersWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBActlValWkToDt);

		String ActualCustomersWkToDtTotal = data.getText("PastWeekActualCustomersWkToDtTotal");
		DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
				ActualCustomersWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBActlTtlWkToDt);
		}
		if (WeekValue.contains("Current") ) {
		...
		ActlValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Customers", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		ActlValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Customers",
				objDailyTradingStatementObjects, objDailyTradingStatementObjects.WeekToDateActlSales);
		...
		LYValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Customers", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateLYSales);
		LYValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Customers", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateLYSales);
		...
		DBVarWkToDt = sql.CLRexecuteQuery(getContext(),
				VarCustomersWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBVarWkToDt);

		String VarCustomersWkToDtTotal = data.getText("PastWeekVarCustomersWkToDtTotal");
		DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
				VarCustomersWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBVarWkToDtTtl);
		}
		if (WeekValue.contains("Current") ) {
		...
		VarWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Customers", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
		VarTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Customers", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
	...
	//////////// BUDGET ///////////////
	@Test(description = "Daily Trading Statement - Store, BudgetView Values", priority = 7)
	public void BudgetColumnValidation() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			DBBdgtSls = sql.CLRexecuteQuery(getContext(),
					BudgetSales.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			...
			DBBdgtSlsTtl = sql.CLRexecuteQuery(getContext(),
					BudgetSalesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBBdgtSlsTtl);

			BdgtSls = pageDailyTradingStatementStorePO.WeekToDateData("Sales", objDailyTradingStatementObjects,
					objDailyTradingStatementObjects.BudgetSales);
			BdgtSlsTtl = pageDailyTradingStatementStorePO.WeekToDateTotal("Sales", objDailyTradingStatementObjects,
					objDailyTradingStatementObjects.BudgetSales);
		...
		if (OptionToView.contains("Forecast")) {
			...
			DBBdgtSls = sql.CLRexecuteQuery(getContext(),
					ForecastSales.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBBdgtSls);

			String ForecastSalesTotal = data.getText("ForecastSalesTotal");
			DBBdgtSlsTtl = sql.CLRexecuteQuery(getContext(),
					ForecastSalesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBBdgtSlsTtl);
		...
		if (OptionToView.contains("Budget")) {
			...
			DBBdgtWg = sql.CLRexecuteQuery(getContext(),
					BudgetWagePercentage.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			...
			DBBdgtWgTtl = sql.CLRexecuteQuery(getContext(),
					BudgetWagePercentageTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBBdgtWgTtl);

			BdgtWg = pageDailyTradingStatementStorePO.WeekToDateData("WagesPercentage", objDailyTradingStatementObjects,
					objDailyTradingStatementObjects.BudgetSales);
			BdgtWgTtl = pageDailyTradingStatementStorePO.WeekToDateTotal("WagesPercentage",
					objDailyTradingStatementObjects, objDailyTradingStatementObjects.BudgetSales);
		...
		if (OptionToView.contains("Forecast")) {
			...
			DBBdgtWg = sql.CLRexecuteQuery(getContext(),
					ForecastWagePercentage.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBBdgtWg);
		...
		if (OptionToView.contains("Budget")) {
			...
			DBBdgtSls = sql.CLRexecuteQuery(getContext(),
					BudgetWages.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBBdgtSls);

			String BudgetWagesTotal = data.getText("BudgetWagesTotal");
			DBBdgtSlsTtl = sql.CLRexecuteQuery(getContext(),
					BudgetWagesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBBdgtSlsTtl);

			BdgtSls = pageDailyTradingStatementStorePO.WeekToDateData("Wages", objDailyTradingStatementObjects,
					objDailyTradingStatementObjects.BudgetSales);
			BdgtSlsTtl = pageDailyTradingStatementStorePO.WeekToDateTotal("Wages", objDailyTradingStatementObjects,
					objDailyTradingStatementObjects.BudgetSales);
		...
		if (OptionToView.contains("Forecast")) {
			...
			DBBdgtSls = sql.CLRexecuteQuery(getContext(),
					ForecastWages.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBBdgtSls);

			String ForecastWagesTotal = data.getText("ForecastWagesTotal");
			DBBdgtSlsTtl = sql.CLRexecuteQuery(getContext(),
					ForecastWagesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBBdgtSlsTtl);
		...
		DBEstFcstSls = sql.CLRexecuteQuery(getContext(),
				EstimatedFcstSales.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		...
		DBEstFcstSlsTtl = sql.CLRexecuteQuery(getContext(),
				EstimatedFcstSalesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		...
		EstFcstSls = pageDailyTradingStatementStorePO.WeekToDateData("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.EstForecastSales);
		EstFcstSlsTtl = pageDailyTradingStatementStorePO.WeekToDateTotal("Sales", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.EstForecastSales);
		...
		if (WeekValue.contains("Past") ) {
			...
			DBEstFcstWgs = sql.CLRexecuteQuery(getContext(),
					EstimatedFcstWage.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			...
			DBEstFcstWgsTtl = sql.CLRexecuteQuery(getContext(),
					EstimatedFcstWageTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		...
		if (WeekValue.contains("Current")) {
			...
			DBEstFcstWgs = sql.CLRexecuteQuery(getContext(),
					CurrentEstimatedFcstWage.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBEstFcstWgs);
		...
		EstFcstWgs = pageDailyTradingStatementStorePO.WeekToDateData("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.EstForecastSales);
		EstFcstWgsTtl = pageDailyTradingStatementStorePO.WeekToDateTotal("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.EstForecastSales);
		...
		if (WeekValue.contains("Past") ) {
			...
			DBEstFcstWgsPrcnt = sql.CLRexecuteQuery(getContext(),
					EstimatedFcstWagePrcnt.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		...
		EstFcstWgsPrcnt = pageDailyTradingStatementStorePO.WeekToDateData("WagesPercentage",
				objDailyTradingStatementObjects, objDailyTradingStatementObjects.EstForecastSales);
		EstFcstWgsPrcntTtl = pageDailyTradingStatementStorePO.WeekToDateTotal("WagesPercentage",
				objDailyTradingStatementObjects, objDailyTradingStatementObjects.EstForecastSales);
		...
		// Variance Sales
		if (OptionToView.contains("Budget")) {
			Report_AddStep("testcase", " VARIANCE SALES - BUDGET COLUMN", "", "", "");
			...
			DBVarSales = sql.CLRexecuteQuery(getContext(),
					VarSales.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			...
			DBVarSalesTtl = sql.CLRexecuteQuery(getContext(),
					VarSalesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			...
			VarSls = pageDailyTradingStatementStorePO.WeekToDateData("Sales", objDailyTradingStatementObjects,
					objDailyTradingStatementObjects.VarBudgetSales);
			VarSalesTtl = pageDailyTradingStatementStorePO.WeekToDateTotal("Sales", objDailyTradingStatementObjects,
					objDailyTradingStatementObjects.VarBudgetSales);
		...
		if (OptionToView.contains("Forecast")) {
			Report_AddStep("testcase", " VARIANCE SALES - FORECAST COLUMN", "", "", "");
			extentTest = report.startTest("Variance Forecast Sales");
			if (WeekValue.contains("Past") ) {
			String ForecastVarSales = data.getText("PastWeekForecastVarSales");
			DBVarSales = sql.CLRexecuteQuery(getContext(),
					ForecastVarSales.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBVarSales);

			String ForecastVarSalesTotal = data.getText("PastWeekForecastVarSalesTotal");
			DBVarSalesTtl = sql.CLRexecuteQuery(getContext(),
					ForecastVarSalesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBVarSalesTtl);
			}
			if (WeekValue.contains("Current") ) {
		...
		// Variance Wages
		if (OptionToView.contains("Budget")) {
			Report_AddStep("testcase", " VARIANCE WAGES - BUDGET COLUMN", "", "", "");
			...
			if (WeekValue.contains("Past") ) {
				...
				DBVarWages = sql.CLRexecuteQuery(getContext(),
						VarWages.replace("store", getContext().getStringProperty("store")).replace("Week",
								getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
				...
				DBVarWagesTtl = sql.CLRexecuteQuery(getContext(),
						VarWagesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
								getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			...
			if (WeekValue.contains("Current")) {
				...
				DBVarWages = sql.CLRexecuteQuery(getContext(),
						CurrentVarWages.replace("store", getContext().getStringProperty("store")).replace("Week",
								getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
				System.out.println("DB Value: " + DBVarWages);

				String CurrentVarWagesTotal = data.getText("CurrentWeekVarWagesTotal");
				DBVarWagesTtl = sql.CLRexecuteQuery(getContext(),
						CurrentVarWagesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
								getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
				System.out.println("DB Value: " + DBVarWagesTtl);
			}

			VarWages = pageDailyTradingStatementStorePO.WeekToDateData("Wages", objDailyTradingStatementObjects,
					objDailyTradingStatementObjects.VarBudgetSales);
			VarWagesTtl = pageDailyTradingStatementStorePO.WeekToDateTotal("Wages", objDailyTradingStatementObjects,
					objDailyTradingStatementObjects.VarBudgetSales);
		...
		if (OptionToView.contains("Forecast")) {
			...
			if (WeekValue.contains("Past") ) {
				...
				DBVarWages = sql.CLRexecuteQuery(getContext(),
						ForecastVarWages.replace("store", getContext().getStringProperty("store")).replace("Week",
								getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
				System.out.println("DB Value: " + DBVarWages);

				String ForecastVarWagesTotal = data.getText("PastWeekForecastVarWagesTotal");
				DBVarWagesTtl = sql.CLRexecuteQuery(getContext(),
						ForecastVarWagesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
								getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
				System.out.println("DB Value: " + DBVarWagesTtl);
			}
			if (WeekValue.contains("Current")) {
		...
		if (OptionToView.contains("Budget")) {
			...
			if (WeekValue.contains("Past") ) {
				...
				DBVarWagesPrcnt = sql.CLRexecuteQuery(getContext(),
						VarWagesPrecentage.replace("store", getContext().getStringProperty("store")).replace("Week",
								getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			...
			VarWagesPrcnt = pageDailyTradingStatementStorePO.WeekToDateData("WagesPercentage",
					objDailyTradingStatementObjects, objDailyTradingStatementObjects.VarBudgetSales);
			VarWagesPrcntTtl = pageDailyTradingStatementStorePO.WeekToDateTotal("WagesPercentage",
					objDailyTradingStatementObjects, objDailyTradingStatementObjects.VarBudgetSales);
		...
		if (OptionToView.contains("Forecast")) {
			Report_AddStep("testcase", " VARIANCE WAGES PERCENTAGE - FORECAST COLUMN", "", "", "");
	...
	//////////// WAGES PERCENTAGE ///////////////
	@Test(description = "Daily Trading Statement - Store, WagePercent Values", priority = 8)
	public void WagesPercentageColumnValidation() throws Exception {
		...
		pageDailyTradingStatementStorePO = new MonthlyPlanningGroupPage().createPage(getDriver(), getContext(), log,
				status, data, getReport(), getReportLogger(), DailyTradingStatementStorePage.class);
		TestStatus status = getTestStatus();
		System.out.println("Entering into TestCase : DTS Store - Wage% View");
		WeekValue = getContext().getStringProperty("WeekToTest");
		...
		DBPlndVal = sql.CLRexecuteQuery(getContext(),
				PlannedWagesPercentage.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndVal);

		String PlannedWagesPercentageTotal = data.getText("PlannedWagesPercentageTotal");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
				PlannedWagesPercentageTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtl);

		PlndVal = pageDailyTradingStatementStorePO.DayWiseUIData("WagesPercentage", "PlannedValue",
				objDailyTradingStatementObjects);
		PlndValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("WagesPercentage", "PlannedValue",
				objDailyTradingStatementObjects);
		...
		DBActlVal = sql.CLRexecuteQuery(getContext(),
				ActualWagesPercentage.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBActlVal);

		String ActualWagesPercentageTotal = data.getText("PastWeekActualWagesPercentageTotal");
		DBActlTtl = sql.CLRexecuteQuery(getContext(),
				ActualWagesPercentageTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBActlTtl);
		}
		if (WeekValue.contains("Current") ) {
			...
			String ActualWagesPercentageTotal = data.getText("CurrentWeeekActualWagesPercentageTotal");
			DBActlTtl = sql.CLRexecuteQuery(getContext(),
					ActualWagesPercentageTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlTtl);
			}
		ActlVal = pageDailyTradingStatementStorePO.DayWiseUIData("WagesPercentage", "ActualValue",
				objDailyTradingStatementObjects);
		ActlValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("WagesPercentage", "ActualValue",
				objDailyTradingStatementObjects);
		...
		DBPlndValWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedWagesPercentageWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValWkToDt);
		...
		PlndValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("WagesPercentage",
				objDailyTradingStatementObjects, objDailyTradingStatementObjects.WeekToDatePlndSales);
		PlndValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("WagesPercentage",
				objDailyTradingStatementObjects, objDailyTradingStatementObjects.WeekToDatePlndSales);
		...
		ActlValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("WagesPercentage",
				objDailyTradingStatementObjects, objDailyTradingStatementObjects.WeekToDateActlSales);
		ActlValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("WagesPercentage",
				objDailyTradingStatementObjects, objDailyTradingStatementObjects.WeekToDateActlSales);
		...
		if (WeekValue.contains("Past") ) {
			...
			DBVarWkToDt = sql.CLRexecuteQuery(getContext(),
					VarWagesPercentageWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBVarWkToDt);
		...
		VarWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("WagesPercentage", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
		VarTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("WagesPercentage",
				objDailyTradingStatementObjects, objDailyTradingStatementObjects.WeekToDateVarSales);
	...
	public void WagesColumnValidation() throws Exception {
		...
		DBPlndVal = sql.CLRexecuteQuery(getContext(),
				PlannedWages.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndVal);

		String PlannedWagesTotal = data.getText("PlannedWagesTotal");
		DBPlndValTtl = sql.CLRexecuteQuery(getContext(),
				PlannedWagesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtl);

		PlndVal = pageDailyTradingStatementStorePO.DayWiseUIData("Wages", "PlannedValue",
				objDailyTradingStatementObjects);
		PlndValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Wages", "PlannedValue",
				objDailyTradingStatementObjects);
		...
		DBActlVal = sql.CLRexecuteQuery(getContext(),
				ActualWages.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBActlVal);

		String ActualWagesTotal = data.getText("PastWeekActualWagesTotal");
		DBActlTtl = sql.CLRexecuteQuery(getContext(),
				ActualWagesTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBActlTtl);
		}
		...
		ActlVal = pageDailyTradingStatementStorePO.DayWiseUIData("Wages", "ActualValue",
				objDailyTradingStatementObjects);
		ActlValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Wages", "ActualValue",
				objDailyTradingStatementObjects);
		...
		LYVal = pageDailyTradingStatementStorePO.DayWiseUIData("Wages", "LYValue", objDailyTradingStatementObjects);
		LYValTtl = pageDailyTradingStatementStorePO.DayWiseUITotal("Wages", "LYValue", objDailyTradingStatementObjects);
		...
		DBPlndValWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedWagesWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValWkToDt);

		String PlannedWagesWkToDtTotal = data.getText("PlannedWagesWkToDtTotal");
		DBPlndValTtlWkToDt = sql.CLRexecuteQuery(getContext(),
				PlannedWagesWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
						getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBPlndValTtlWkToDt);

		PlndValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
		PlndValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDatePlndSales);
		...
		if (WeekValue.contains("Past") ) {
			...
			DBActlValWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualWagesWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlValWkToDt);

			String ActualWagesWkToDtTotal = data.getText("PastWeekActualWagesWkToDtTotal");
			DBActlTtlWkToDt = sql.CLRexecuteQuery(getContext(),
					ActualWagesWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlTtlWkToDt);
		}
		if (WeekValue.contains("Current")) {
			...
			DBActlValWkToDt = sql.CLRexecuteQuery(getContext(),
					CurrentActualWagesWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBActlValWkToDt);
		...
		ActlValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		ActlValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateActlSales);
		...
		LYValWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateLYSales);
		LYValTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateLYSales);
		...
		if (WeekValue.contains("Past") ) {
			...
			DBVarWkToDt = sql.CLRexecuteQuery(getContext(),
					VarWagesWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBVarWkToDt);

			String VarWagesWkToDtTotal = data.getText("PastWeekVarWagesWkToDtTotal");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
					VarWagesWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBVarWkToDtTtl);
		}
		if (WeekValue.contains("Current")) {
			...
			DBVarWkToDt = sql.CLRexecuteQuery(getContext(),
					CurrentVarWagesWkToDt.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBVarWkToDt);

			String CurrentVarWagesWkToDtTotal = data.getText("CurrentWeekVarWagesWkToDtTotal");
			DBVarWkToDtTtl = sql.CLRexecuteQuery(getContext(),
					CurrentVarWagesWkToDtTotal.replace("store", getContext().getStringProperty("store")).replace("Week",
							getContext().getStringProperty("SelectFiscalWeek")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBVarWkToDtTtl);
		}

		VarWkToDt = pageDailyTradingStatementStorePO.WeekToDateData("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
		VarTtlWkToDt = pageDailyTradingStatementStorePO.WeekToDateTotal("Wages", objDailyTradingStatementObjects,
				objDailyTradingStatementObjects.WeekToDateVarSales);
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\DailyTradingStatementStore.xml");
