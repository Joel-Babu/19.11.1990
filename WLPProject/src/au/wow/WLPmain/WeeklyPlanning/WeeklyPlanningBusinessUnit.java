...
public class WeeklyPlanningBusinessUnit extends TestBase {

	protected Logger log = LogManager.getLogger(WeeklyPlanningBusinessUnit.class);
	TestStatus status;
	...
	public WeeklyPlanningBusinessUnit() {
		super.log = log;
	}
	...
	// Sales
	@Test(description = "Weekly Planning - BusinessUnits, Sales history - First Week", priority = 1)
	public void SalesHistoryFirstWeek() throws Exception {
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.screenToView, "Business Unit");
		/*pageWeeklyPlanningPO.verifyPageName(extentTest, objWeeklyPlanningStoreObjects.DataFrame,
				objWeeklyPlanningStoreObjects.pageName, getContext().getStringProperty("WeeklyPlanningBU"));*/
	...
	@Test(description = "Weekly Planning - BusinessUnits, Sales history - Second Week", priority = 2)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Sales history - Third Week", priority = 3)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Sales history - Fourth Week", priority = 4)
	...
	// Wages
	@Test(description = "Weekly Planning - BusinessUnits, Wages history - First Week", priority = 5)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Wages history - Second Week", priority = 6)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Wages history - Third Week", priority = 7)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Wages history - Fourth Week", priority = 8)
	...
	// Items
	@Test(description = "Weekly Planning - BusinessUnits, Items history - First Week", priority = 9)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Items history - Second Week", priority = 10)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Items history - Third Week", priority = 11)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Items history - Fourth Week", priority = 12)
	...
	// Customers
	@Test(description = "Weekly Planning - BusinessUnits, Customers history - First Week", priority = 13)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Customers history - Second Week", priority = 14)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Customers history - Third Week", priority = 15)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Customers history - Fourth Week", priority = 16)
	...
	// Item Price
	@Test(description = "Weekly Planning - BusinessUnits, Item Price history - First Week", priority = 17)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Item Price history - Second Week", priority = 18)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Item Price history - Third Week", priority = 19)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Item Price history - Fourth Week", priority = 20)
	...
	// Wage Percentage
	@Test(description = "Weekly Planning - BusinessUnits, WagePercentage history - First Week", priority = 21)
	...
	@Test(description = "Weekly Planning - BusinessUnits, WagePercentage history - Second Week", priority = 22)
	...
	@Test(description = "Weekly Planning - BusinessUnits, WagePercentage history - Third Week", priority = 23)
	...
	@Test(description = "Weekly Planning - BusinessUnits, WagePercentage history - Fourth Week", priority = 24)
	...
	// Paid Hours
	@Test(description = "Weekly Planning - BusinessUnits, Paid Hours history - First Week", priority = 25)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Paid Hours history - Second Week", priority = 26)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Paid Hours history - Third Week", priority = 27)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Paid Hours history - Fourth Week", priority = 28)
	...
	// CPH
	@Test(description = "Weekly Planning - BusinessUnits, CPH history - First Week", priority = 29)
	...
	@Test(description = "Weekly Planning - BusinessUnits, CPH history - Second Week", priority = 30)
	...
	@Test(description = "Weekly Planning - BusinessUnits, CPH history - Third Week", priority = 31)
	...
	@Test(description = "Weekly Planning - BusinessUnits, CPH history - Fourth Week", priority = 32)
	...
	////////////////////////// CURRENT MONTH ///////////////////////////////
	@Test(description = "Weekly Planning - BusinessUnits, Budget Sales - Current Week", priority = 33)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Generated Sales- Current Week", priority = 34)
	...
	@Test(description = "Weekly Planning - BusinessUnits, Planned Sales- Current Week", priority = 35)
	...
	// Var to BUD
	@Test(description = "Weekly Planning - BusinessUnits, Var to Bud - Current Week", priority = 36)
	...
	// +/- LY%
	//Jenkins Run
	/*@Test(description = "Weekly Planning - BusinessUnits, +/- LY% - Current Week", priority = 37)
...
*/
	// +/- Bud%
	@Test(description = "Weekly Planning - BusinessUnits, +/- Bud% - Current Week", priority = 38)
	...
	// Planned Item Price
	@Test(description = "Weekly Planning - BusinessUnits, Planned Item Price - Current Week", priority = 39)
	...
	//Jenkins Run
	/*@Test(description = "Weekly Planning - BusinessUnits, Planned percent on LY - Current Week", priority = 40)
...
*/
	// Planned Items
	@Test(description = "Weekly Planning - BusinessUnits, Planned Items - Current Week", priority = 41)
	...
	// Planned IPLH
	@Test(description = "Weekly Planning - BusinessUnits, Planned IPLH Items - Current Week", priority = 42)
	...
	// Budget Wages
	@Test(description = "Weekly Planning - BusinessUnits, Budget Wages - Current Week", priority = 43)
	...
	// Planned Wages
	@Test(description = "Weekly Planning - BusinessUnits, Planned Wages - Current Week", priority = 44)
	...
	// Planned % on LY
	@Test(description = "Weekly Planning - BusinessUnits, Planned % on LY Wages - Current Week", priority = 45)
	...
	// Budget Wage%
	@Test(description = "Weekly Planning - BusinessUnits, Budget WagesPercentage - Current Week", priority = 46)
	...
	// Planned Wage%
	@Test(description = "Weekly Planning - BusinessUnits, Planned WagesPercentage - Current Week", priority = 47)
	...
	// LY Wage%
	//Jenkins Run
/*	@Test(description = "Weekly Planning - BusinessUnits, PlannedLY WagesPercentage - Current Week", priority = 48)
	...
	// SMS Hours
	@Test(description = "Weekly Planning - BusinessUnits, SMS Hours - Current Week", priority = 49)
	...
	// Planned Hours
	@Test(description = "Weekly Planning - BusinessUnits, PlannedHours - Current Week", priority = 50)
	...
	// Hours LY
	@Test(description = "Weekly Planning - BusinessUnits, HoursLY - Current Week", priority = 51)
	...
	// Planned OR
	@Test(description = "Weekly Planning - BusinessUnits, Planned OR - Current Week", priority = 52)
	...
	// Planned CPH
	@Test(description = "Weekly Planning - BusinessUnits, Planned CPH - Current Week", priority = 54)
	...
	// Growth LY CPH
	@Test(description = "Weekly Planning - BusinessUnits, Growth LY CPH - Current Week", priority = 55)
	...
	// Planned BDGT Rate
	@Test(description = "Weekly Planning - BusinessUnits, Planned BDGT Rate - Current Week", priority = 55)
	...
	@Test(description = "Weekly Planning - BU, MonthlyViewMetricsValidation", priority = 57)
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\WeeklyPlanningBU.xml");
