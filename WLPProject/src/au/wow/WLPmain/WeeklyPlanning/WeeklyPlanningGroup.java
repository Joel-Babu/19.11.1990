...
public class WeeklyPlanningGroup extends TestBase {
	...
	// Sales
	@Test(description = "Weekly Planning - Group, Sales history - First Week", priority = 1)
	...
	@Test(description = "Weekly Planning - Group, Sales history - Second Week", priority = 2)
	...
	@Test(description = "Weekly Planning - Group, Sales history - Third Week", priority = 3)
	...
	@Test(description = "Weekly Planning - Group, Sales history - Fourth Week", priority = 4)
	...
	// Wages
	@Test(description = "Weekly Planning - Group, Wages history - First Week", priority = 5)
	...
	@Test(description = "Weekly Planning - Group, Wages history - Second Week", priority = 6)
	...
	@Test(description = "Weekly Planning - Group, Wages history - Third Week", priority = 7)
	...
	@Test(description = "Weekly Planning - Group, Wages history - Fourth Week", priority = 8)
	...
	// Items
	@Test(description = "Weekly Planning - Group, Items history - First Week", priority = 9)
	...
	@Test(description = "Weekly Planning - Group, Items history - Second Week", priority = 10)
	...
	@Test(description = "Weekly Planning - Group, Items history - Third Week", priority = 11)
	...
	@Test(description = "Weekly Planning - Group, Items history - Fourth Week", priority = 12)
	...
	// Customers
	@Test(description = "Weekly Planning - Group, Customers history - First Week", priority = 13)
	...
	@Test(description = "Weekly Planning - Group, Customers history - Second Week", priority = 14)
	...
	@Test(description = "Weekly Planning - Group, Customers history - Third Week", priority = 15)
	...
	@Test(description = "Weekly Planning - Group, Customers history - Fourth Week", priority = 16)
	...
	// Item Price
	@Test(description = "Weekly Planning - Group, Item Price history - First Week", priority = 17)
	...
	@Test(description = "Weekly Planning - Group, Item Price history - Second Week", priority = 18)
	...
	@Test(description = "Weekly Planning - Group, Item Price history - Third Week", priority = 19)
	...
	@Test(description = "Weekly Planning - Group, Item Price history - Fourth Week", priority = 20)
	...
	// Wage Percentage
	@Test(description = "Weekly Planning - Group, WagePercentage history - First Week", priority = 21)
	...
	@Test(description = "Weekly Planning - Group, WagePercentage history - Second Week", priority = 22)
	...
	@Test(description = "Weekly Planning - Group, WagePercentage history - Third Week", priority = 23)
	...
	@Test(description = "Weekly Planning - Group, WagePercentage history - Fourth Week", priority = 24)
	...
	// Paid Hours
	@Test(description = "Weekly Planning - Group, Paid Hours history - First Week", priority = 25)
	...
	@Test(description = "Weekly Planning - Group, Paid Hours history - Second Week", priority = 26)
	...
	@Test(description = "Weekly Planning - Group, Paid Hours history - Third Week", priority = 27)
	...
	@Test(description = "Weekly Planning - Group, Paid Hours history - Fourth Week", priority = 28)
	...
	// CPH
	@Test(description = "Weekly Planning - Group, CPH history - First Week", priority = 29)
	...
	@Test(description = "Weekly Planning - Group, CPH history - Second Week", priority = 30)
	...
	@Test(description = "Weekly Planning - Group, CPH history - Third Week", priority = 31)
	...
	@Test(description = "Weekly Planning - Group, CPH history - Fourth Week", priority = 32)
...
/*	@Test(description = "Weekly Planning - BU, OR History - First Week", priority = 33)
	public void ORHistoryFirstWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				ORHistory.replace("Region", getContext().getStringProperty("Region"))
						...
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Year", getContext().getStringProperty("Year")).replace("Week", HWk1)
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				ORHistoryTotal.replace("Region", getContext().getStringProperty("Region"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWk", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Week", HWk1).replace("Year", getContext().getStringProperty("Year"))
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
	...
	public void ORHistorySecondWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				ORHistory.replace("Region", getContext().getStringProperty("Region"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWk", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Week", HWk2).replace("Year", getContext().getStringProperty("Year"))
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
	...
	public void ORHistoryThirdWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				ORHistory.replace("Region", getContext().getStringProperty("Region"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWk", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Week", HWk3).replace("Year", getContext().getStringProperty("Year"))
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
	...
	public void ORHistoryFourthWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				ORHistory.replace("Region", getContext().getStringProperty("Region"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWk", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Week", HWk4).replace("Year", getContext().getStringProperty("Year"))
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
	...
	////////////////////////// CURRENT MONTH ///////////////////////////////
	@Test(description = "Weekly Planning - Group, Budget Sales - Current Week", priority = 37)
	...
	@Test(description = "Weekly Planning - Group, Generated Sales- Current Week", priority = 38)
	...
	@Test(description = "Weekly Planning - Group, Planned Sales- Current Week", priority = 39)
	...
	// Var to BUD
	@Test(description = "Weekly Planning - Group, Var to Bud - Current Week", priority = 40)
	...
	// +/- LY%
	@Test(description = "Weekly Planning - Group, +/- LY% - Current Week", priority = 41)
	...
	// +/- Bud%
	@Test(description = "Weekly Planning - Group, +/- Bud% - Current Week", priority = 42)
	...
	// Planned Item Price
	@Test(description = "Weekly Planning - Group, Planned Item Price - Current Week", priority = 43)
	...
	@Test(description = "Weekly Planning - Group, Planned percent on LY - Current Week", priority = 44)
	...
	// Planned Items
	@Test(description = "Weekly Planning - Group, Planned Items - Current Week", priority = 45)
	...
	// Planned IPLH
	@Test(description = "Weekly Planning - Group, Planned IPLH Items - Current Week", priority = 46)
	...
	// Budget Wages
	@Test(description = "Weekly Planning - Group, Budget Wages - Current Week", priority = 47)
	...
	// Planned Wages
	@Test(description = "Weekly Planning - Group, Planned Wages - Current Week", priority = 48)
	...
	// Planned % on LY
	@Test(description = "Weekly Planning - Group, Planned % on LY Wages - Current Week", priority = 49)
	...
	// Budget Wage%
	@Test(description = "Weekly Planning - Group, Budget WagesPercentage - Current Week", priority = 50)
	...
	// Planned Wage%
	@Test(description = "Weekly Planning - Group, Planned WagesPercentage - Current Week", priority = 51)
	...
	// LY Wage%
	@Test(description = "Weekly Planning - Group, PlannedLY WagesPercentage - Current Week", priority = 52)
	...
	// SMS Hours
	@Test(description = "Weekly Planning - Group, SMS Hours - Current Week", priority = 53)
	...
	// Planned Hours
	@Test(description = "Weekly Planning - Group, PlannedHours - Current Week", priority = 54)
	...
	// Hours LY
	@Test(description = "Weekly Planning - Group, HoursLY - Current Week", priority = 55)
	public void HoursLY_CurrentMonth() throws Exception {
		...
		pageWeeklyPlanningPO.CompareValuesforLYHours(extentTest, DBValues, UIValues);
	...
	// Planned OR
	@Test(description = "Weekly Planning - Group, Planned OR - Current Week", priority = 56)
	...
	// Planned CPH
	@Test(description = "Weekly Planning - Group, Planned CPH - Current Week", priority = 58)
	...
	// Growth LY CPH
	@Test(description = "Weekly Planning - Group, Growth LY CPH - Current Week", priority = 59)
	...
	// Planned BDGT Rate
	@Test(description = "Weekly Planning - Group, Planned BDGT Rate - Current Week", priority = 62)
	...
	@Test(description = "Weekly Planning - Group, MonthlyViewMetricsValidation", priority = 61)
