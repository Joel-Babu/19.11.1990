...
public class WeeklyPlanningStore extends TestBase {

	protected Logger log = LogManager.getLogger(WeeklyPlanningStore.class);
	TestStatus status;
	...
	List<List<Object>> DBValues, DBValues1, DBValues2, DBValues3, DBValues4, DBValues5, DBTotal, DBTotal1, DBTotal2,
			DBTotal3, DBTotal4, DBTotal5, DBPstive, DBNgtive, DBbgdtsls, DBbgdtslsTtl, DBbgdtWg, DBbgdtWgTtl;
	...
	public void SalesHistoryFirstWeek() throws Exception {
		...
		extentTest.log(LogStatus.INFO, "SALES HISTORY - FIRST WEEK");

		String SalesHistory = data.getText("SalesHistory");
		DBValues = sql.CLRexecuteQuery(getContext(),
				SalesHistory.replace("store", getContext().getStringProperty("store"))
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				SalesHistoryTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);

		UIValues = pageWeeklyPlanningPO.UIResultsStore(objMonthlyPlanningStoreObjects.MPTable, extentTest,
		...
		UITotal = pageWeeklyPlanningPO.GetTotal(extentTest, objWeeklyPlanningStoreObjects.RowNameTotal,
	...
	public void SalesHistorySecondWeek() throws Exception {
		...
		extentTest.log(LogStatus.INFO, "SALES HISTORY - SECOND WEEK");
		...
		UITotal = pageWeeklyPlanningPO.GetTotal(extentTest, objMonthlyPlanningGroupObjects.RowNameTotal,
	...
	public void SalesHistoryThirdWeek() throws Exception {
		...
		extentTest.log(LogStatus.INFO, "SALES HISTORY - THIRD WEEK");
	...
	public void SalesHistoryFourthWeek() throws Exception {
		...
		extentTest.log(LogStatus.INFO, "SALES HISTORY - FOURTH WEEK");
	...
	public void WagesHistoryFirstWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				WagesHistory.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				WagesHistoryTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
	...
	public void ItemsHistoryFirsthWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				ItemsHistory.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				ItemsHistoryTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
	...
	public void CustomersHistoryFirsthWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				CustomerHistory.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				CustomerHistoryTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
	...
	public void ItemPriceHistoryFirsthWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				ItemPriceHistory.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				ItemPriceHistoryTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
	...
	public void WagePercentageHistoryFirsthWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				WagePercentageHistory.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				WagePercentageHistoryTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
	...
	public void PaidHoursHistoryFirsthWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				PaidHoursHistory.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				PaidHoursHistoryTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
	...
	public void CPHHistoryFirsthWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				CPHHistory.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				CPHHistoryTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
...
/*	@Test(description = "Weekly Planning - BU, OR History - First Week", priority = 33)
	public void ORHistoryFirstWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				ORHistory.replace("store", getContext().getStringProperty("store")).replace("FinWk", Week)
						.replace("Year", getContext().getStringProperty("Year")).replace("Week", HWk1)
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);

		String ORHistoryTotal = data.getText("ORHistoryTotal");
		DBTotal = sql.CLRexecuteQuery(getContext(),
				ORHistoryTotal.replace("store", getContext().getStringProperty("store")).replace("FinWk", Week)
						.replace("Year", getContext().getStringProperty("Year")).replace("Week", HWk1)
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
	...
	@Test(description = "Weekly Planning - BU, OR History - Second Week", priority = 34)
	public void ORHistorySecondWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				ORHistory.replace("store", getContext().getStringProperty("store")).replace("FinWk", Week)
						.replace("Year", getContext().getStringProperty("Year")).replace("Week", HWk2)
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
	...
	@Test(description = "Weekly Planning - BU, OR History - Third Week", priority = 35)
	public void ORHistoryThirdWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				ORHistory.replace("store", getContext().getStringProperty("store")).replace("FinWk", Week)
						.replace("Year", getContext().getStringProperty("Year")).replace("Week", HWk3)
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
	...
	@Test(description = "Weekly Planning - BU, OR History - Fourth Week", priority = 36)
	public void ORHistoryFourthWeek() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				ORHistory.replace("store", getContext().getStringProperty("store")).replace("FinWk", Week)
						.replace("Year", getContext().getStringProperty("Year")).replace("Week", HWk4)
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
...
*/
	////////////////////////// CURRENT MONTH ///////////////////////////////
	@Test(description = "Weekly Planning - Store, Budget Sales - Current Week", priority = 37)
	...
	@Test(description = "Weekly Planning - Store, Generated Sales- Current Week", priority = 38)
	...
	@Test(description = "Weekly Planning - Store, Planned Sales- Current Week", priority = 39)
	...
	// Var to BUD
	@Test(description = "Weekly Planning - Store, Var to Bud - Current Week", priority = 40)
	public void VarToBUDSales_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			DBValues = sql.CLRexecuteQuery(getContext(),
					VartoBUD.replace("store", getContext().getStringProperty("store"))
							.replace("Area", getContext().getStringProperty("Area"))
							.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBValues);
			...
			DBTotal = sql.CLRexecuteQuery(getContext(),
					VartoBUDTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Area", getContext().getStringProperty("Area"))
							.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Total: " + DBTotal);
		...
		if (OptionToView.contains("Forecast")) {
			...
			DBValues = sql.CLRexecuteQuery(getContext(),
					VartoFCST.replace("store", getContext().getStringProperty("store"))
							.replace("Area", getContext().getStringProperty("Area"))
							.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBValues);
			...
			DBTotal = sql.CLRexecuteQuery(getContext(),
					VartoFCSTTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Area", getContext().getStringProperty("Area"))
							.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Total: " + DBTotal);
	...
	// +/- LY%
	@Test(description = "Weekly Planning - Store, +/- LY% - Current Week", priority = 41)
	public void PercentageLYsales_CurrentMonth() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				PercentLYSales.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				PercentLYSalesTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
		...
		pageWeeklyPlanningPO.CompareValueDecimalFields(extentTest, DBValues, UIValues);
	...
	// +/- Bud%
	@Test(description = "Weekly Planning - Store, +/- Bud% - Current Week", priority = 42)
	public void BudgetPercentageSales_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			DBValues = sql.CLRexecuteQuery(getContext(),
					BudgetPercentage.replace("store", getContext().getStringProperty("store"))
							.replace("Area", getContext().getStringProperty("Area"))
							.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBValues);
		...
		if (OptionToView.contains("Forecast")) {
			String ForecastPercentage = data.getText("ForecastPercentage");
			DBValues = sql.CLRexecuteQuery(getContext(),
					ForecastPercentage.replace("store", getContext().getStringProperty("store"))
							.replace("Area", getContext().getStringProperty("Area"))
							.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBValues);
	...
	// Planned Item Price
	@Test(description = "Weekly Planning - Store, Planned Item Price - Current Week", priority = 43)
	...
	@Test(description = "Weekly Planning - Store, Planned percent on LY - Current Week", priority = 44)
	public void PlannedPercentOnLY_CurrentMonth() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				PlannedpercentonLY.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				PlannedpercentonLYTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
	...
	// Planned Items
	@Test(description = "Weekly Planning - Store, Planned Items - Current Week", priority = 45)
	...
	// Planned IPLH
	@Test(description = "Weekly Planning - Store, Planned IPLH Items - Current Week", priority = 46)
	public void PlannedIPLHitems_CurrentMonth() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				PlannedIPLHitems.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				PlannedIPLHitemsTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
	...
	// Budget Wages
	@Test(description = "Weekly Planning - Store, Budget Wages - Current Week", priority = 47)
	...
	// Planned Wages
	@Test(description = "Weekly Planning - Store, Planned Wages - Current Week", priority = 48)
	...
	// Planned % on LY
	@Test(description = "Weekly Planning - Store, Planned % on LY Wages - Current Week", priority = 49)
	public void PlannedLYWages_CurrentMonth() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				PlannedLYWages.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				PlannedLYWagesTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
		...
		UIValues = pageWeeklyPlanningPO.UIResultsStore(objMonthlyPlanningStoreObjects.MPTable, extentTest,
				objWeeklyPlanningStoreObjects.DepartmentNames, objWeeklyPlanningStoreObjects.PlannedPercentonLYWages);
		pageWeeklyPlanningPO.CompareValueDecimalFields(extentTest, DBValues, UIValues);

		UITotal = pageWeeklyPlanningPO.GetTotal(extentTest, objMonthlyPlanningGroupObjects.RowNameTotal,
				objWeeklyPlanningStoreObjects.PlannedPercentonLYWages);
		pageMonthlyPlanningPO.CompareValueDecimalFields(extentTest, DBTotal, UITotal);
	}

	// Budget Wage%
	@Test(description = "Weekly Planning - Store, Budget WagesPercentage - Current Week", priority = 50)
	public void BudgetWagesPercentage_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			DBTotal = sql.CLRexecuteQuery(getContext(),
					BudgetWagesPercentageTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Area", getContext().getStringProperty("Area"))
							.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Total: " + DBTotal);
		...
		if (OptionToView.contains("Forecast")) {
			...
			DBTotal = sql.CLRexecuteQuery(getContext(),
					ForecastWagesPercentageTotal.replace("store", getContext().getStringProperty("store"))
							.replace("Area", getContext().getStringProperty("Area"))
							.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Total: " + DBTotal);
	...
	// Planned Wage%
	@Test(description = "Weekly Planning - Store, Planned WagesPercentage - Current Week", priority = 51)
	...
	// LY Wage%
	@Test(description = "Weekly Planning - Store, PlannedLY WagesPercentage - Current Week", priority = 52)
	public void LYWagesPercentage_CurrentMonth() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				LYWagesPercentage.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
	...
	public void HoursLY_CurrentMonth() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				HoursLY.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
		...
		DBTotal = sql.CLRexecuteQuery(getContext(),
				HoursLYTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Total: " + DBTotal);
	...
	public void BGDT_FCST_OR_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			DBValues = sql.CLRexecuteQuery(getContext(),
					BudgetOR.replace("store", getContext().getStringProperty("store")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBValues);

			String BudgetORTotal = data.getText("BudgetORTotal");
			DBTotal = sql.CLRexecuteQuery(getContext(),
					BudgetORTotal.replace("store", getContext().getStringProperty("store")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Total: " + DBTotal);
		...
		if (OptionToView.contains("Forecast")) {
			...
			DBValues = sql.CLRexecuteQuery(getContext(),
					ForecastOR.replace("store", getContext().getStringProperty("store")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + DBValues);

			String ForecastORTotal = data.getText("ForecastORTotal");
			DBTotal = sql.CLRexecuteQuery(getContext(),
					ForecastORTotal.replace("store", getContext().getStringProperty("store")).replace("FinWeek", Week)
							.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Total: " + DBTotal);
	...
	public void GrowthLYCPH_CurrentMonth() throws Exception {
		...
		DBValues = sql.CLRexecuteQuery(getContext(),
				GrowthLYCPH.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", getContext().getStringProperty("Year")).replace("LYFinYr", LYYr).replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + DBValues);
	...
	// Planned BDGT Rate
	@Test(description = "Weekly Planning - Store, Planned BDGT Rate - Current Week", priority = 60)
	...
	@Test(description = "Weekly Planning - Store, MonthlyViewMetricsValidation", priority = 62)
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\WeeklyPlanningStore.xml");
