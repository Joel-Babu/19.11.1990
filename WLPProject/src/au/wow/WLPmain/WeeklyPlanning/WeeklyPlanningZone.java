...
public class WeeklyPlanningZone extends TestBase {

	protected Logger log = LogManager.getLogger(WeeklyPlanningZone.class);
	TestStatus status;
	...
	// Sales
	@Test(description = "Weekly Planning - Zone, Sales history - First Week", priority = 1)
	public void SalesHistoryFirstWeek() throws Exception {
		...
		/*pageWeeklyPlanningPO.verifyPageName(extentTest, objWeeklyPlanningStoreObjects.DataFrame,
				objWeeklyPlanningStoreObjects.pageName, getContext().getStringProperty("WeeklyPlanningZone"));*/
	...
	@Test(description = "Weekly Planning - Zone, Sales history - Second Week", priority = 2)
	...
	@Test(description = "Weekly Planning - Zone, Sales history - Third Week", priority = 3)
	...
	@Test(description = "Weekly Planning - Zone, Sales history - Fourth Week", priority = 4)
	...
	// Wages
	@Test(description = "Weekly Planning - Zone, Wages history - First Week", priority = 5)
	...
	@Test(description = "Weekly Planning - Zone, Wages history - Second Week", priority = 6)
	...
	@Test(description = "Weekly Planning - Zone, Wages history - Third Week", priority = 7)
	...
	@Test(description = "Weekly Planning - Zone, Wages history - Fourth Week", priority = 8)
	...
	// Items
	@Test(description = "Weekly Planning - Zone, Items history - First Week", priority = 9)
	...
	@Test(description = "Weekly Planning - Zone, Items history - Second Week", priority = 10)
	...
	@Test(description = "Weekly Planning - Zone, Items history - Third Week", priority = 11)
	...
	@Test(description = "Weekly Planning - Zone, Items history - Fourth Week", priority = 12)
	...
	// Customers
	@Test(description = "Weekly Planning - Zone, Customers history - First Week", priority = 13)
	...
	@Test(description = "Weekly Planning - Zone, Customers history - Second Week", priority = 14)
	...
	@Test(description = "Weekly Planning - Zone, Customers history - Third Week", priority = 15)
	...
	@Test(description = "Weekly Planning - Zone, Customers history - Fourth Week", priority = 16)
	...
	// Item Price
	@Test(description = "Weekly Planning - Zone, Item Price history - First Week", priority = 17)
	...
	@Test(description = "Weekly Planning - Zone, Item Price history - Second Week", priority = 18)
	...
	@Test(description = "Weekly Planning - Zone, Item Price history - Third Week", priority = 19)
	...
	@Test(description = "Weekly Planning - Zone, Item Price history - Fourth Week", priority = 20)
	...
	// Wage Percentage
	@Test(description = "Weekly Planning - Zone, WagePercentage history - First Week", priority = 21)
	...
	@Test(description = "Weekly Planning - Zone, WagePercentage history - Second Week", priority = 22)
	...
	@Test(description = "Weekly Planning - Zone, WagePercentage history - Third Week", priority = 23)
	...
	@Test(description = "Weekly Planning - Zone, WagePercentage history - Fourth Week", priority = 24)
	...
	// Paid Hours
	@Test(description = "Weekly Planning - Zone, Paid Hours history - First Week", priority = 25)
	...
	@Test(description = "Weekly Planning - Zone, Paid Hours history - Second Week", priority = 26)
	...
	@Test(description = "Weekly Planning - Zone, Paid Hours history - Third Week", priority = 27)
	...
	@Test(description = "Weekly Planning - Zone, Paid Hours history - Fourth Week", priority = 28)
	...
	// CPH
	@Test(description = "Weekly Planning - Zone, CPH history - First Week", priority = 29)
	...
	@Test(description = "Weekly Planning - Zone, CPH history - Second Week", priority = 30)
	...
	@Test(description = "Weekly Planning - Zone, CPH history - Third Week", priority = 31)
	...
	@Test(description = "Weekly Planning - Zone, CPH history - Fourth Week", priority = 32)
	...
	@Test(description = "Weekly Planning - Zone, Generated Sales- Current Week", priority = 38)
	...
	@Test(description = "Weekly Planning - Zone, Planned Sales- Current Week", priority = 39)
	...
	// Var to BUD
	@Test(description = "Weekly Planning - Zone, Var to Bud - Current Week", priority = 40)
	...
	// +/- LY%
	@Test(description = "Weekly Planning - Zone, +/- LY% - Current Week", priority = 41)
	...
	// +/- Bud%
	@Test(description = "Weekly Planning - Zone, +/- Bud% - Current Week", priority = 42)
	...
	// Planned Item Price
	@Test(description = "Weekly Planning - Zone, Planned Item Price - Current Week", priority = 43)
	...
	@Test(description = "Weekly Planning - Zone, Planned percent on LY - Current Week", priority = 44)
	...
	// Planned Items
	@Test(description = "Weekly Planning - Zone, Planned Items - Current Week", priority = 45)
	...
	// Planned IPLH
	@Test(description = "Weekly Planning - Zone, Planned IPLH Items - Current Week", priority = 46)
	...
	// Budget Wages
	@Test(description = "Weekly Planning - Zone, Budget Wages - Current Week", priority = 47)
	...
	// Planned Wages
	@Test(description = "Weekly Planning - Zone, Planned Wages - Current Week", priority = 48)
	...
	// Planned % on LY
	@Test(description = "Weekly Planning - Zone, Planned % on LY Wages - Current Week", priority = 49)
	...
	// Budget Wage%
	@Test(description = "Weekly Planning - Zone, Budget WagesPercentage - Current Week", priority = 50)
	...
	// Planned Wage%
	@Test(description = "Weekly Planning - Zone, Planned WagesPercentage - Current Week", priority = 51)
	...
	// LY Wage%
	@Test(description = "Weekly Planning - Zone, PlannedLY WagesPercentage - Current Week", priority = 52)
	...
	// SMS Hours
	@Test(description = "Weekly Planning - Zone, SMS Hours - Current Week", priority = 53)
	public void SMSHours_CurrentMonth() throws Exception {
		...
		pageMonthlyPlanningPO.CompareValueDecimalFieldsSMS(extentTest, DBTotal, UITotal);
	}

	// Planned Hours
	@Test(description = "Weekly Planning - Zone, PlannedHours - Current Week", priority = 54)
	...
	// Hours LY
	@Test(description = "Weekly Planning - Zone, HoursLY - Current Week", priority = 55)
	...
	// Planned OR
	@Test(description = "Weekly Planning - Zone, Planned OR - Current Week", priority = 56)
	...
	@Test(description = "Weekly Planning - Zone, Budget_Forecast_Target OR - Current Week", priority = 57)
	...
	// Planned CPH
	@Test(description = "Weekly Planning - Zone, Planned CPH - Current Week", priority = 58)
	...
	// Growth LY CPH
	@Test(description = "Weekly Planning - Zone, Growth LY CPH - Current Week", priority = 59)
	...
	// Planned BDGT Rate
	@Test(description = "Weekly Planning - Zone, Planned BDGT Rate - Current Week", priority = 60)
	...
	@Test(description = "Weekly Planning - Zone, MonthlyViewMetricsValidation", priority = 61)
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\WeeklyPlanningZone.xml");
