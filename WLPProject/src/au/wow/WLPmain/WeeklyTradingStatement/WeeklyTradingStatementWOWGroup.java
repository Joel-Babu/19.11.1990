...
public class WeeklyTradingStatementWOWGroup extends TestBase {
	protected Logger log = LogManager.getLogger(WeeklyTradingStatementWOWGroup.class);
	TestStatus status;
	...
	public WeeklyTradingStatementWOWGroup() {
		super.log = log;
	}
	...
	// Sales
	@Test(description = "Weekly Trading Statement - WOWGroup, SalesColumnValidation", priority = 1)
	public void SalesColumnValidation() throws Exception {
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.screenToViewWeeklyTrading, "Woolworths Group");
		//pageWeeklyPlanningPO.verifyPageName(extentTest, objWeeklyPlanningStoreObjects.DataFrame,
			//	objWeeklyPlanningStoreObjects.pageName, getContext().getStringProperty("WTSWOWGroup"));
	...
	@Test(description = "Weekly Trading Statement - WOWGroup, Planned Item", priority = 2)
	...
	// Customers
	@Test(description = "Weekly Trading Statement - WOWGroup, This Year Customer", priority = 3)
	...
	@Test(description = "Weekly Trading Statement - WOWGroup, Growth in SMS Hours", priority = 4)
	...
	/*	Report_AddStep("testcase", "VARIANCE SMS - WEEK WISE DATA", "", "", "");
		...
		VarSMSHr = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Departments,
				objWeeklyTradingStatementWOWGroupObjects.VarSMSHours,
				objWeeklyTradingStatementWOWGroupObjects.DataTable);
		VarSMSHrTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
				objWeeklyTradingStatementWOWGroupObjects.VarSMSHoursTtl);

		pageMonthlyPlanningPO.CompareValueDecimalFields(extentTest, DBVarSMSHrTtl, VarSMSHr);
	...
	/*	Report_AddStep("testcase", "ACTUAL SMS - WEEK WISE DATA", "", "", "");
		...
		ActlSMSHr = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Departments,
				objWeeklyTradingStatementWOWGroupObjects.ActualSMSHours,
				objWeeklyTradingStatementWOWGroupObjects.DataTable);
		ActlSMSHrTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
				objWeeklyTradingStatementWOWGroupObjects.ActualSMSHoursTtl);

		pageMonthlyPlanningPO.CompareValueDecimalFields(extentTest, DBActlSMSHrTtl, ActlSMSHr);
		...
		ORHr = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Departments,
				objWeeklyTradingStatementWOWGroupObjects.ORPercentageHours,
				objWeeklyTradingStatementWOWGroupObjects.DataTable);
		ORHrTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
				objWeeklyTradingStatementWOWGroupObjects.ORPercentageHoursTtl);

		pageMonthlyPlanningPO.CompareValueDecimalFields(extentTest, DBORHrTtl, ORHr);
		pageMonthlyPlanningPO.CompareValueDecimalFields(extentTest, DBORHrTtl, ORHrTtl); */
	}

	// Wages
	@Test(description = "Weekly Trading Statement - WOWGroup, Actual Wages", priority = 5)
	public void WagesColumnValidation() throws Exception {
		...
		ActlWgVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Departments,
				objWeeklyTradingStatementWOWGroupObjects.ActualWageswts,
				objWeeklyTradingStatementWOWGroupObjects.DataTable);
		ActlWgTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
				objWeeklyTradingStatementWOWGroupObjects.ActualWagesTtlwts);
		...
		ActlWgPrcntVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Departments,
				objWeeklyTradingStatementWOWGroupObjects.ActualWagesPercentagewts,
				objWeeklyTradingStatementWOWGroupObjects.DataTable);
		ActlWgPrcntTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
				objWeeklyTradingStatementWOWGroupObjects.ActualWagesPercentageTtlwts);
		...
		if (OptionToView.contains("Budget")) {
			...
			BdgtWgVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
					objWeeklyTradingStatementWOWGroupObjects.Departments,
					objWeeklyTradingStatementWOWGroupObjects.BudgetWageswts,
					objWeeklyTradingStatementWOWGroupObjects.DataTable);
			BdgtWgTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
					objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
					objWeeklyTradingStatementWOWGroupObjects.BudgetWagesTtlwts);
		...
		if (OptionToView.contains("Budget")) {
			...
			BdgtWgPrcntVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
					objWeeklyTradingStatementWOWGroupObjects.Departments,
					objWeeklyTradingStatementWOWGroupObjects.BudgetWagesPercentagewts,
					objWeeklyTradingStatementWOWGroupObjects.DataTable);
			BdgtWgPrcntTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
					objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
					objWeeklyTradingStatementWOWGroupObjects.BudgetWagesPercentageTtlwts);
		...
		PlndCPHVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Departments,
				objWeeklyTradingStatementWOWGroupObjects.PlannedCPHWageswts,
				objWeeklyTradingStatementWOWGroupObjects.DataTable);
		PlndCPHTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
				objWeeklyTradingStatementWOWGroupObjects.PlannedCPHWagesTtlwts);
		...
		PlndWgVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Departments,
				objWeeklyTradingStatementWOWGroupObjects.PlannedWageswts,
				objWeeklyTradingStatementWOWGroupObjects.DataTable);
		PlndWgTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
				objWeeklyTradingStatementWOWGroupObjects.PlannedWagesTtlwts);
		...
		PlndWgPrcntVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Departments,
				objWeeklyTradingStatementWOWGroupObjects.PlannedWagesPercentagewts,
				objWeeklyTradingStatementWOWGroupObjects.DataTable);
		PlndWgPrcntTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
				objWeeklyTradingStatementWOWGroupObjects.PlannedWagesPercentageTtlwts);
		...
		CPHWgVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Departments,
				objWeeklyTradingStatementWOWGroupObjects.CPHWageswts,
				objWeeklyTradingStatementWOWGroupObjects.DataTable);
		CPHWgTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
				objWeeklyTradingStatementWOWGroupObjects.CPHWagesTtlwts);
		 ...
		 * objWeeklyTradingStatementStoreObjects,
		 * objWeeklyTradingStatementWOWGroupObjects.Departments,
		 * objWeeklyTradingStatementWOWGroupObjects.VarBudgetWages,
		 * objWeeklyTradingStatementWOWGroupObjects.DataTable); VarBdgtWgTtl =
		...
		// Allowed Wages Validation
				if (OptionToView.contains("Budget")) {	
					Report_AddStep("testcase", "AllowedWages Validation", "", "", "");
					...
					AllowedWgVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
							objWeeklyTradingStatementWOWGroupObjects.Departments,
							objWeeklyTradingStatementWOWGroupObjects.AllowedWageswts,
							objWeeklyTradingStatementWOWGroupObjects.DataTable);
					AllowedWgTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
							objWeeklyTradingStatementWOWGroupObjects.TotalTitle,
							objWeeklyTradingStatementWOWGroupObjects.AllowedWagesTtlwts);

					pageMonthlyPlanningPO.CompareValues(extentTest, DBAllowedWgTtl, AllowedWgVal);
	...
	//////////////////////////////////////////////// ////////////////////////////////////////////////
	// Sales
	@Test(description = "Weekly Trading Statement - WOWGroup, SalesColumnValidationNewTable", priority = 6)
	public void SalesColumnValidationNewTable() throws Exception {
		...
		ActlVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks, objWeeklyTradingStatementWOWGroupObjects.ActualSalesNew,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		ActlTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.ActualSalesTtlNew);
		...
		PlndVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks,
				objWeeklyTradingStatementWOWGroupObjects.WeeklyPlannedSales,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		PlndTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.WeeklyPlannedSalesTtl);
		...
		PlndVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks,
				objWeeklyTradingStatementWOWGroupObjects.MonthlyPlannedSales,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		PlndTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.MonthlyPlannedSalesTtl);
		...
		if (OptionToView.contains("Budget")) {
			...
			BdgtVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
					objWeeklyTradingStatementWOWGroupObjects.Weeks,
					objWeeklyTradingStatementWOWGroupObjects.BudgetSalesNew,
					objWeeklyTradingStatementWOWGroupObjects.Table);
			BdgtTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
					objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
					objWeeklyTradingStatementWOWGroupObjects.BudgetSalesTtlNew);
		...
		if (OptionToView.contains("Forecast")) {
			...
			BdgtVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
					objWeeklyTradingStatementWOWGroupObjects.Weeks,
					objWeeklyTradingStatementWOWGroupObjects.ForecastSalesNew,
					objWeeklyTradingStatementWOWGroupObjects.Table);
			BdgtTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
					objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
					objWeeklyTradingStatementWOWGroupObjects.ForecastSalesTtlNew);
	...
	///// WAGES///
	@Test(description = "Weekly Trading Statement - WOWGroup, SalesColumnValidationNewTable", priority = 7)
	public void WagesColumnValidationNewTable() throws Exception {
		...
		ActlVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks, objWeeklyTradingStatementWOWGroupObjects.ActualWagesNew,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		ActlTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.ActualWagesTtlNew);
		...
		PlndVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks,
				objWeeklyTradingStatementWOWGroupObjects.WeeklyPlannedWages,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		PlndTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.WeeklyPlannedWagesTtl);
		...
		PlndVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks,
				objWeeklyTradingStatementWOWGroupObjects.MonthlyPlannedWages,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		PlndTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.MonthlyPlannedWagesTtl);
		...
		if (OptionToView.contains("Budget")) {
			...
			BdgtVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
					objWeeklyTradingStatementWOWGroupObjects.Weeks,
					objWeeklyTradingStatementWOWGroupObjects.BudgetWagesNew,
					objWeeklyTradingStatementWOWGroupObjects.Table);
			BdgtTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
					objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
					objWeeklyTradingStatementWOWGroupObjects.BudgetWagesTtlNew);
		...
		if (OptionToView.contains("Forecast")) {
			...
			BdgtVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
					objWeeklyTradingStatementWOWGroupObjects.Weeks,
					objWeeklyTradingStatementWOWGroupObjects.ForecastWagesNew,
					objWeeklyTradingStatementWOWGroupObjects.Table);
			BdgtTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
					objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
					objWeeklyTradingStatementWOWGroupObjects.ForecastWagesTtlNew);
	...
	///// WAGE%///
	@Test(description = "Weekly Trading Statement - WOWGroup, WagePercentageColumnValidationNewTable", priority = 8)
	public void WagePercentageColumnValidationNewTable() throws Exception {
		...
		ActlVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks,
				objWeeklyTradingStatementWOWGroupObjects.ActualWagePerNew,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		ActlTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.ActualWagePerTtlNew);
		...
		PlndVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks,
				objWeeklyTradingStatementWOWGroupObjects.WeeklyPlannedWagePer,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		PlndTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.WeeklyPlannedWagePerTtl);
		...
		PlndVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks,
				objWeeklyTradingStatementWOWGroupObjects.MonthlyPlannedWagePer,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		PlndTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.MonthlyPlannedWagePerTtl);
		...
		if (OptionToView.contains("Budget")) {
			...
			BdgtVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
					objWeeklyTradingStatementWOWGroupObjects.Weeks,
					objWeeklyTradingStatementWOWGroupObjects.BudgetWagePerNew,
					objWeeklyTradingStatementWOWGroupObjects.Table);
			BdgtTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
					objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
					objWeeklyTradingStatementWOWGroupObjects.BudgetWagePerTtlNew);
		...
		if (OptionToView.contains("Forecast")) {
			...
			BdgtVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
					objWeeklyTradingStatementWOWGroupObjects.Weeks,
					objWeeklyTradingStatementWOWGroupObjects.ForecastWagePerNew,
					objWeeklyTradingStatementWOWGroupObjects.Table);
			BdgtTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
					objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
					objWeeklyTradingStatementWOWGroupObjects.ForecastWagePerTtlNew);
	...
	///// OR///
	@Test(description = "Weekly Trading Statement - WOWGroup, ORColumnValidationNewTable", priority = 9)
	public void ORColumnValidationNewTable() throws Exception {
		...
		ActlVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks, objWeeklyTradingStatementWOWGroupObjects.ActualORNew,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		ActlTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.ActualORTtlNew);
		...
		PlndVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks,
				objWeeklyTradingStatementWOWGroupObjects.WeeklyPlannedOR,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		PlndTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.WeeklyPlannedORTtl);
		...
		PlndVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks,
				objWeeklyTradingStatementWOWGroupObjects.MonthlyPlannedOR,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		PlndTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.MonthlyPlannedORTtl);
	...
	///// CPH///
	@Test(description = "Weekly Trading Statement - WOWGroup, CPHColumnValidationNewTable", priority = 10)
	public void CPHColumnValidationNewTable() throws Exception {
		...
		ActlVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks, objWeeklyTradingStatementWOWGroupObjects.ActualCPHNew,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		ActlTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.ActualCPHTtlNew);
		...
		PlndVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks,
				objWeeklyTradingStatementWOWGroupObjects.WeeklyPlannedCPH,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		PlndTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.WeeklyPlannedCPHTtl);
		...
		PlndVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementWOWGroupObjects.Weeks,
				objWeeklyTradingStatementWOWGroupObjects.MonthlyPlannedCPH,
				objWeeklyTradingStatementWOWGroupObjects.Table);
		PlndTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementWOWGroupObjects.MonthTotal,
				objWeeklyTradingStatementWOWGroupObjects.MonthlyPlannedCPHTtl);
