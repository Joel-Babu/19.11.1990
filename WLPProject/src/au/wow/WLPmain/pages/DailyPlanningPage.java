...
public class DailyPlanningPage extends TestBase {
	...
	public List<List<Object>> UIResultsStore(DailyPlanningStoreObjects objDailyPlanningStoreObjects, String Table,
	...
	// Get Week to Date
	public List<List<Object>> WkToDtValueStore(DailyPlanningStoreObjects objDailyPlanningStoreObjects, String Table,
