...
//////////// Sales ///////////////
  ...
  //Planned Sales
		...
		if (WeekValue.contains("Past") ) {
 		...
 		DBActlValTtl = sql.CLRexecuteQuery(getContext(), ActualSalesTotal.replace("store",getContext().getStringProperty("store")).replace("Division", getContext().getStringProperty("Division"))
				.replace("Week",getContext().getStringProperty("SelectFiscalWeek")).replace("Department",getContext().getStringProperty("Longlife")));
		System.out.println("DB Value: "+DBActlValTtl); 
		
		String ActualSalesTotalSF = data.getText("PastWeekActualSalesTotal");	
		DBActlValTtlSF = sql.CLRexecuteQuery(getContext(), ActualSalesTotalSF.replace("store",getContext().getStringProperty("store")).replace("Division", getContext().getStringProperty("Division"))
				.replace("Week",getContext().getStringProperty("SelectFiscalWeek")).replace("Department",getContext().getStringProperty("SeaFoodDeli")));
		...
		if (WeekValue.contains("Current") ) {
			...
			String ActualSalesTotalSF = data.getText("CurrentWeekActualSalesTotal");	
			DBActlValTtlSF = sql.CLRexecuteQuery(getContext(), ActualSalesTotalSF.replace("store",getContext().getStringProperty("store")).replace("Division", getContext().getStringProperty("Division"))
					.replace("Week",getContext().getStringProperty("SelectFiscalWeek")).replace("Department",getContext().getStringProperty("SeaFoodDeli")));
			System.out.println("DB Value: "+DBActlValTtlSF); 
			}
		ActlValTtl = pageDailyTradingStatementStorePO.CombinedPastUITotal("LLSales",objDailyTradingStatementObjects,objDailyTradingStatementObjects.MondayActlSales,objDailyTradingStatementObjects.TuesdayActlSales,
					objDailyTradingStatementObjects.WednesdayActlSales,objDailyTradingStatementObjects.ThursdayActlSales,objDailyTradingStatementObjects.ThursdayActlSalesYellow,
					objDailyTradingStatementObjects.FridayActlSales,objDailyTradingStatementObjects.FridayActlSalesYellow,
					objDailyTradingStatementObjects.SaturdayActlSales,objDailyTradingStatementObjects.SaturdayActlSalesYellow,
					objDailyTradingStatementObjects.SundayActlSales,objDailyTradingStatementObjects.SundayActlSalesYellow,objDailyTradingStatementObjects.Table); 
		
				ActlValTtlSF = pageDailyTradingStatementStorePO.CombinedPastUITotal("SFSales",objDailyTradingStatementObjects,objDailyTradingStatementObjects.MondayActlSales,objDailyTradingStatementObjects.TuesdayActlSales,
						objDailyTradingStatementObjects.WednesdayActlSales,objDailyTradingStatementObjects.ThursdayActlSales,objDailyTradingStatementObjects.ThursdayActlSalesYellow,
						objDailyTradingStatementObjects.FridayActlSales,objDailyTradingStatementObjects.FridayActlSalesYellow,
						objDailyTradingStatementObjects.SaturdayActlSales,objDailyTradingStatementObjects.SaturdayActlSalesYellow,
						objDailyTradingStatementObjects.SundayActlSales,objDailyTradingStatementObjects.SundayActlSalesYellow,objDailyTradingStatementObjects.Table);
		...
		pageDailyTradingStatementStorePO.DTSCompareValuesTotal(extentTest,DBActlValTtl,ActlValTtl); 
		pageDailyTradingStatementStorePO.DTSCompareValuesTotal(extentTest,DBActlValTtlSF,ActlValTtlSF); 
...
//////////// WAGES PERCENTAGE ///////////////
@Test(description = "Daily Trading Statement - Store, Wagespercentage Values",priority=8)
public void WagesPercentageColumnValidation() throws Exception
{
		...
		pageDailyTradingStatementStorePO = new MonthlyPlanningGroupPage().createPage(getDriver(), getContext(), log, status, data,getReport(), getReportLogger(), DailyTradingStatementStorePage.class);
		TestStatus status = getTestStatus();
		System.out.println("Entering into TestCase : DTS Store - Wagespercentage View");
		WeekValue = getContext().getStringProperty("WeekToTest");
		...
		Report_AddStep("testcase", " PLANNED WAGE% - Week to date ", "", "", "");
		extentTest = report.startTest(" Planned WagesPercentage - Week to date");
		...
		Report_AddStep("testcase", " ACTUAL WAGE% - Week to date ", "", "", "");
		extentTest = report.startTest(" Actual WagesPercentage - Week to date ");
		...
		Report_AddStep("testcase", " VARIANCE WAGE% - Week to date ", "", "", "");
		extentTest = report.startTest(" Variance WagesPercentage - Week to date ");
...
public void loadXMLFile() {
	try {
		...
		log.info("Loading data for the class: ");
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\DTS_Store_CombinedView.xml");
